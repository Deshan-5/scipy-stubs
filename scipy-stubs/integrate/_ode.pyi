...
_Inexact64T_co = TypeVar(
    "_Inexact64T_co", bound=npc.inexact, default=Any, covariant=True
)
...
class ode(Generic[_Inexact64T_co, *_Ts]):
    ...
    jac: (
        Callable[[float, onp.Array1D[_Inexact64T_co], *_Ts], complex | onp.ToComplex2D]
        | None
    )
    f_params: tuple[*_Ts]
    ...
    def __init__(
        ...
        /,
        f: Callable[
            [float, onp.Array1D[_Inexact64T_co], *_Ts], complex | onp.ToComplex1D
        ],
        jac: (
            Callable[
                [float, onp.Array1D[_Inexact64T_co], *_Ts], complex | onp.ToComplex2D
            ]
            | None
        ) = None,
    ) -> None: ...
    ...
    @overload
    def set_initial_value(
        self: ode[npc.complexfloating, *_Ts],
        /,
        y: complex | onp.ToComplex1D,
        t: float = 0.0,
    ) -> ode[_Inexact64T_co, *_Ts]: ...
    ...
    @overload
    def set_integrator(
        self: ode[npc.floating, *_Ts],
        /,
        name: _IntegratorReal,
        **integrator_params: Unpack[_IntegratorParams],
    ) -> ode[_Inexact64T_co, *_Ts]: ...
    @overload
    def set_integrator(
        self: ode[npc.complexfloating, *_Ts],
        /,
        name: _IntegratorComplex,
        **integrator_params: Unpack[_IntegratorParams],
    ) -> ode[_Inexact64T_co, *_Ts]: ...

    #
    def integrate(
        self, /, t: float, step: bool = False, relax: bool = False
    ) -> onp.Array1D[_Inexact64T_co]: ...
    ...
    def set_solout(
        self,
        /,
        solout: Callable[[float, onp.Array1D[_Inexact64T_co]], Literal[-1, 0] | None],
    ) -> None: ...
...
class complex_ode(ode[np.complex128, *_Ts], Generic[*_Ts]):
    ...
    cjac: (
        Callable[[float, onp.Array1D[np.complex128], *_Ts], complex | onp.ToComplex2D]
        | None
    )
    ...
    @override
    def set_initial_value(
        self, /, y: complex | onp.ToComplex1D, t: float = 0.0
    ) -> Self: ...
...
class IntegratorBase(Generic[_Inexact64T_co]):
    ...
    ]  # fortran function or unavailable
...
class dopri5(IntegratorBase[np.float64]):
    ...
    def set_solout(
        self,
        /,
        solout: Callable[[float, onp.Array1D[np.float64]], Literal[0, -1]] | None,
        complex: bool = False,
    ) -> None: ...
