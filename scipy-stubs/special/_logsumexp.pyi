...
_InexactOrArrayT = TypeVar(
    "_InexactOrArrayT", bound=npc.inexact | onp.ArrayND[npc.inexact]
)
...
def logsumexp(
    ...
    *,
    ...
    onp.ArrayND[np.float64 | Any] | Any, onp.ArrayND[np.float64 | Any] | Any
]: ...
...
def logsumexp(
    ...
    *,
    ...
    onp.ArrayND[np.float64 | Any] | Any, onp.ArrayND[np.complex128 | Any] | Any
]: ...
...
@overload  # 0d +float64
def softmax(
    x: onp.ToInt | onp.ToJustFloat64, axis: AnyShape | None = None
) -> np.float64: ...
@overload  # 0d ~complex128
def softmax(x: onp.ToJustComplex128, axis: AnyShape | None = None) -> np.complex128: ...
@overload  # nd T@inexact
def softmax(
    x: onp.ToArrayND[Never, _InexactT], axis: AnyShape | None = None
) -> onp.ArrayND[_InexactT]: ...
@overload  # nd +float64
def softmax(
    x: onp.ToIntND | onp.ToJustFloat64_ND, axis: AnyShape | None = None
) -> onp.ArrayND[np.float64]: ...
@overload  # nd ~complex128
def softmax(
    x: onp.ToJustComplex128_ND, axis: AnyShape | None = None
) -> onp.ArrayND[np.complex128]: ...
...
def softmax(
    x: onp.ToFloatND, axis: AnyShape | None = None
) -> onp.ArrayND[np.float64 | Any]: ...
@overload  # nd complex fallback
def softmax(
    x: onp.ToComplexND, axis: AnyShape | None = None
) -> onp.ArrayND[np.complex128 | Any]: ...

# NOTE: keep in sync with `softmax`
@overload  # T
def log_softmax(
    x: _InexactOrArrayT, axis: AnyShape | None = None
) -> _InexactOrArrayT: ...
@overload  # 0d +float64
def log_softmax(
    x: onp.ToInt | onp.ToJustFloat64, axis: AnyShape | None = None
...
@overload  # 0d ~complex128
def log_softmax(
    x: onp.ToJustComplex128, axis: AnyShape | None = None
) -> np.complex128: ...
@overload  # nd T@inexact
def log_softmax(
    x: onp.ToArrayND[Never, _InexactT], axis: AnyShape | None = None
...
@overload  # 0d complex fallback
def log_softmax(
    x: onp.ToComplex, axis: AnyShape | None = None
) -> np.complex128 | Any: ...
@overload  # nd float fallback
def log_softmax(
    x: onp.ToFloatND, axis: AnyShape | None = None
