...
def airyzo(
    nt: int, kf: int
) -> tuple[_Double1D, _Double1D, _Double1D, _Double1D]: ...  # undocumented
...
def cyzo(
    nt: int, kf: int, kc: int
) -> tuple[_CDouble1D, _CDouble1D]: ...  # undocumented
...
def pbdv(
    v: float, x: float
) -> tuple[_Double1D, _Double1D, float, float]: ...  # undocumented
def pbvv(
    v: float, x: float
) -> tuple[_Double1D, _Double1D, float, float]: ...  # undocumented
def sdmn(m: int, n: int, c: float, cv: float, kd: int) -> _Double1D: ...  # undocumented
def segv(
    m: int, n: int, c: float, kd: int
) -> tuple[float, _Double1D]: ...  # undocumented
