...
_PointsWeightsMu: TypeAlias = tuple[
    onp.Array1D[np.float64], onp.Array1D[np.float64], np.float64
]
...
class orthopoly1d(np.poly1d):  # undocumented
    ...
    @overload
    def __call__(
        self, /, v: onp.ArrayND[npc.floating | npc.integer | np.bool_, _ShapeT]
    ) -> onp.ArrayND[np.float64, _ShapeT]: ...
    @overload
    def __call__(
        self, /, v: onp.ArrayND[npc.complexfloating, _ShapeT]
...
@overload
def roots_jacobi(
    n: onp.ToInt, alpha: onp.ToFloat, beta: onp.ToFloat, mu: onp.ToFalse = False
) -> _PointsWeights: ...
@overload
def roots_jacobi(
    n: onp.ToInt, alpha: onp.ToFloat, beta: onp.ToFloat, mu: onp.ToTrue
) -> _PointsWeightsMu: ...

#
@overload
def roots_sh_jacobi(
    n: onp.ToInt, p1: onp.ToFloat, q1: onp.ToFloat, mu: onp.ToFalse = False
) -> _PointsWeights: ...
@overload
def roots_sh_jacobi(
    n: onp.ToInt, p1: onp.ToFloat, q1: onp.ToFloat, mu: onp.ToTrue
) -> _PointsWeightsMu: ...

#
@overload
def roots_genlaguerre(
    n: onp.ToInt, alpha: onp.ToFloat, mu: onp.ToFalse = False
) -> _PointsWeights: ...
@overload
def roots_genlaguerre(
    n: onp.ToInt, alpha: onp.ToFloat, mu: onp.ToTrue
) -> _PointsWeightsMu: ...
...
def jacobi(
    n: onp.ToInt, alpha: onp.ToFloat, beta: onp.ToFloat, monic: bool = False
) -> orthopoly1d: ...
def laguerre(n: onp.ToInt, monic: bool = False) -> orthopoly1d: ...
def genlaguerre(
    n: onp.ToInt, alpha: onp.ToFloat, monic: bool = False
) -> orthopoly1d: ...
...
def sh_jacobi(
    n: onp.ToInt, p: onp.ToFloat, q: onp.ToFloat, monic: bool = False
) -> orthopoly1d: ...
