...
_ToJustComplexND: TypeAlias = (
    onp.CanArrayND[_Complex]
    | onp.SequenceND[onp.CanArrayND[_Complex]]
    | onp.SequenceND[_ToJustComplex]
)
...
_Float2_D: TypeAlias = onp.Array[
    onp.AtLeast2D[Any], np.float64
]  # pyright: ignore[reportInvalidTypeForm]
_Float3_D: TypeAlias = onp.Array[
    onp.AtLeast3D[Any], np.float64
]  # pyright: ignore[reportInvalidTypeForm]
...
# https://github.com/microsoft/pyright/issues/11127
_Complex2_D: TypeAlias = onp.Array[
    onp.AtLeast2D[Any], np.complex128
]  # pyright: ignore[reportInvalidTypeForm]
_Complex3_D: TypeAlias = onp.Array[
    onp.AtLeast3D[Any], np.complex128
]  # pyright: ignore[reportInvalidTypeForm]
...
class _LegendreP(Protocol):
    @overload  # 0-d, 0-d
    def __call__(
        self, /, n: onp.ToInt, z: onp.ToFloat, *, diff_n: _Dn = 0
    ) -> _Float1D: ...
    @overload  # 0-d, >0-d
    def __call__(
        self, /, n: onp.ToInt, z: onp.ToFloatND, *, diff_n: _Dn = 0
    ) -> _Float2_D: ...
    @overload  # >0-d, >=0-d
    def __call__(
        self, /, n: onp.ToIntND, z: _ToFloat_D, *, diff_n: _Dn = 0
    ) -> _Float2_D: ...
...
class _LegendrePAll(Protocol):
    @overload  # float
    def __call__(
        self, /, n: onp.ToInt, z: _ToFloat_D, *, diff_n: _Dn = 0
    ) -> _Float3_D: ...
    @overload  # complex
    def __call__(
        self, /, n: onp.ToInt, z: _ToJustComplex_D, *, diff_n: _Dn = 0
    ) -> _Complex3_D: ...
    @overload  # float or complex
    def __call__(
        self, /, n: onp.ToInt, z: _ToComplex_D, *, diff_n: _Dn = 0
...
class _SphLegendreP(Protocol):
    ...
    def __call__(
        self, /, n: onp.ToInt, m: onp.ToInt, theta: onp.ToFloat, *, diff_n: _Dn = 0
    ) -> _Float1D: ...
    @overload  # >=0-d, >=0-d, >0-d
    def __call__(
        self, /, n: _ToInt_D, m: _ToInt_D, theta: onp.ToFloatND, *, diff_n: _Dn = 0
    ) -> _Float2_D: ...
    @overload  # >=0-d, >0-d, >=0-d
    def __call__(
        self, /, n: _ToInt_D, m: onp.ToIntND, theta: _ToFloat_D, *, diff_n: _Dn = 0
    ) -> _Float2_D: ...
    @overload  # >0-d, >=0-d, >=0-d
    def __call__(
        self, /, n: onp.ToIntND, m: _ToInt_D, theta: _ToFloat_D, *, diff_n: _Dn = 0
    ) -> _Float2_D: ...
...
class _SphLegendrePAll(Protocol):
    ...
    @overload  # 0-d, 0-d, >=0-d
    def __call__(
        self, /, n: onp.ToInt, m: onp.ToInt, theta: _ToFloat_D, *, diff_n: _Dn = 0
    ) -> _Float3_D: ...
...
class MultiUFunc(Generic[_UFuncT_co]):  # undocumented
    ...
    def __call__(
        self: MultiUFunc[Callable[_Tss, _RT]],
        /,
        *args: _Tss.args,
        **kwargs: _Tss.kwargs,
    ) -> _RT: ...
