...
swapped_code: Final[Literal[">", "<"]] = (
    ...
)  # undocumented  # ">" sys.byteorder == "little" else "<"
...
class VarReader5:  # undocumented
    ...
    def read_numeric(
        self, /, copy: _bint = True, nnz: int = -1
    ) -> onp.Array1D[Any]: ...
    ...
    def array_from_header(
        self, /, header: VarHeader5, process: _bint = 1
    ) -> Any: ...  # squeezed ndarray or sparse csc_array
    def shape_from_header(self, /, header: VarHeader5) -> tuple[int, ...]: ...
    def read_real_complex(
        self, /, header: VarHeader5
