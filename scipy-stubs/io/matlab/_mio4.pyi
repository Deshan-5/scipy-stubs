...
_DT_co = TypeVar(
    "_DT_co", covariant=True, bound=np.dtype[np.generic], default=np.dtype[np.generic]
)
...
class VarHeader4(Generic[_DT_co]):
    ...
    def __init__(
        self, /, name: str, dtype: _DT_co, mclass: _MClass, dims: int, is_complex: bool
    ) -> None: ...
...
class VarReader4:
    ...
    def read_sub_array(
        self, /, hdr: _SupportsVarHeader[_DT], copy: bool = True
    ) -> np.ndarray[tuple[int, ...], _DT]: ...
    def read_full_array(
        self, /, hdr: _SupportsVarHeader[_DT]
    ) -> np.ndarray[tuple[int, ...], _DT]: ...
    def read_char_array(
        self, /, hdr: _SupportsVarHeader[_DT]
    ) -> np.ndarray[tuple[int, ...], _DT]: ...
...
class MatFile4Reader(MatFileReader):
    def __init__(
        self, /, mat_stream: IO[bytes], *args: bool | str, **kwargs: bool | str
    ) -> None: ...
    ...
    def get_variables(
        self, /, variable_names: str | Sequence[str] | None = None
    ) -> dict[str, onp.ArrayND]: ...
...
class MatFile4Writer:
    ...
    oned_as: _OnedAs
    def __init__(
        self, /, file_stream: IO[bytes], oned_as: _OnedAs | None = None
    ) -> None: ...
    def put_variables(
        self, /, mdict: Mapping[str, onp.ArrayND], write_header: bool | None = None
    ) -> None: ...
