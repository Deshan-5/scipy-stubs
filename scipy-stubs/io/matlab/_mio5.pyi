...
class MatFile5Reader(MatFileReader):
    ...
    def read_var_array(
        self, /, header: Mapping[str, object], process: bool = True
    ) -> onp.Array: ...
    def get_variables(
        self, /, variable_names: Iterable[str] | None = None
...
class VarWriter5:
    ...
    def write_smalldata_element(
        self, /, arr: onp.Array, mdtype: int, byte_count: int
    ) -> None: ...
    def write_regular_element(
        self, /, arr: onp.Array, mdtype: int, byte_count: int
    ) -> None: ...
    def write_header(
        self,
    ...
    def write_char(
        self, /, arr: onp.ArrayND[np.str_], codec: str = "ascii"
    ) -> None: ...
...
class MatFile5Writer:
    ...
    def put_variables(
        self, /, mdict: Mapping[str, onp.Array], write_header: bool | None = None
    ) -> None: ...
