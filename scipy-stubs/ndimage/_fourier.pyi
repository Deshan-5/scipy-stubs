...
_OutputArrayComplexT = TypeVar(
    "_OutputArrayComplexT", bound=onp.ArrayND[_ScalarComplex]
)
...
def _get_output_fourier(
    output: _OutputArrayT, input: onp.ToComplex128_ND
) -> _OutputArrayT: ...
@overload  # output: <T: scalar type>
def _get_output_fourier(
    output: type[_OutputScalarT], input: onp.ToComplex128_ND
...
@overload  # ~complex128
def _get_output_fourier(
    output: None, input: onp.ToJustComplex128_ND
) -> onp.ArrayND[np.complex128]: ...
@overload  # ~complex64
def _get_output_fourier(
    output: None, input: onp.ToJustComplex64_ND
) -> onp.ArrayND[np.complex64]: ...
@overload  # fallback
def _get_output_fourier(
    output: None, input: onp.ToComplex128_ND
) -> onp.ArrayND[_Scalar]: ...

# undocumented
@overload  # output: complex64 | complex128 array or scalar-type
def _get_output_fourier_complex(
    output: onp.ArrayND[_OutputScalarComplexT] | type[_OutputScalarComplexT],
    input: onp.ToComplex128_ND,
...
def fourier_shift(
    ...
    n: SupportsIndex,
    axis: int,
    output: type[_OutputScalarComplexT],
) -> onp.ArrayND[_OutputScalarComplexT]: ...
@overload  # output: <T: scalar type> (keyword)
def fourier_shift(
    input: onp.ToComplex128_ND,
...
def fourier_shift(
    input: onp.ToJustComplex128_ND | onp.ToFloat64_ND,
    shift: _Sigma,
    n: SupportsIndex = -1,
    axis: int = -1,
    output: None = None,
