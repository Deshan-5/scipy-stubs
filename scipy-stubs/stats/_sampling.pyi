...
class CustomDistPINV(Generic[_RT_co]):  # undocumented
    def __init__(
        self,
        /,
        pdf: Callable[Concatenate[onp.ToFloat, ...], _RT_co],
...
def argus_gamma_inv_trf(
    x: onp.ToFloat, chi: onp.ToFloat
) -> onp.ToFloat: ...  # undocumented
def betaprime_pdf(
    x: onp.ToFloat, a: onp.ToFloat, b: onp.ToFloat
) -> float | np.float64: ...  # undocumented
...
def burr_pdf(
    x: onp.ToFloat, cc: op.CanFloat, dd: op.CanFloat
) -> np.float64 | Literal[0]: ...  # undocumented
def burr12_pdf(
    x: onp.ToFloat, cc: onp.ToFloat, dd: onp.ToFloat
) -> float: ...  # undocumented
...
def crystalball_pdf(
    x: onp.ToFloat, b: onp.ToFloat, m: onp.ToFloat
) -> float: ...  # undocumented
...
def geninvgauss_pdf(
    x: onp.ToFloat, p: onp.ToFloat, b: onp.ToFloat
) -> float: ...  # undocumented
