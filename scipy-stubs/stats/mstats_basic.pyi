...
@deprecated("will be removed in SciPy v2.0.0")
def rankdata(
    data: object, axis: object = None, use_missing: object = False
) -> object: ...
@deprecated("will be removed in SciPy v2.0.0")
...
@deprecated("will be removed in SciPy v2.0.0")
def theilslopes(
    y: object, x: object = None, alpha: object = 0.95, method: object = "separate"
) -> object: ...
@deprecated("will be removed in SciPy v2.0.0")
def siegelslopes(
    y: object, x: object = None, method: object = "hierarchical"
) -> object: ...
@deprecated("will be removed in SciPy v2.0.0")
def sen_seasonal_slopes(x: object) -> object: ...
@deprecated("will be removed in SciPy v2.0.0")
def ttest_onesamp(
    a: object, popmean: object, axis: object = 0, alternative: object = "two-sided"
) -> object: ...
@deprecated("will be removed in SciPy v2.0.0")
def ttest_1samp(
    a: object, popmean: object, axis: object = 0, alternative: object = "two-sided"
...
@deprecated("will be removed in SciPy v2.0.0")
def ttest_rel(
    a: object, b: object, axis: object = 0, alternative: object = "two-sided"
) -> object: ...
@deprecated("will be removed in SciPy v2.0.0")
...
@deprecated("will be removed in SciPy v2.0.0")
def trima(
    a: object, limits: object = None, inclusive: object = (True, True)
) -> object: ...
@deprecated("will be removed in SciPy v2.0.0")
def trimr(
    a: object,
...
@deprecated("will be removed in SciPy v2.0.0")
def tmin(
    a: object, lowerlimit: object = None, axis: object = 0, inclusive: object = True
) -> object: ...
@deprecated("will be removed in SciPy v2.0.0")
def tmax(
    a: object, upperlimit: object = None, axis: object = 0, inclusive: object = True
) -> object: ...
@deprecated("will be removed in SciPy v2.0.0")
def tsem(
    a: object,
...
@deprecated("will be removed in SciPy v2.0.0")
def kurtosis(
    a: object, axis: object = 0, fisher: object = True, bias: object = True
) -> object: ...
@deprecated("will be removed in SciPy v2.0.0")
def describe(
    a: object, axis: object = 0, ddof: object = 0, bias: object = True
) -> object: ...
@deprecated("will be removed in SciPy v2.0.0")
def skewtest(
    a: object, axis: object = 0, alternative: object = "two-sided"
) -> object: ...
@deprecated("will be removed in SciPy v2.0.0")
def kurtosistest(
    a: object, axis: object = 0, alternative: object = "two-sided"
...
def plotting_positions(
    data: object, alpha: object = 0.4, beta: object = 0.4
) -> object: ...
@deprecated("will be removed in SciPy v2.0.0")
...
@deprecated("will be removed in SciPy v2.0.0")
def brunnermunzel(
    x: object, y: object, alternative: object = "two-sided", distribution: object = "t"
) -> object: ...
