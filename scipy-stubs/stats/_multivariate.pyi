...
_ScalarT_co = TypeVar(
    "_ScalarT_co", bound=np.generic, default=np.float64, covariant=True
)

# TODO(@jorenham): rename as {}T_co
_RVG_co = TypeVar(
    "_RVG_co", bound=multi_rv_generic, default=multi_rv_generic, covariant=True
)
...
_Array2ND: TypeAlias = onp.Array[
    tuple[int, int, *tuple[Any, ...]], _ScalarT
]  # pyright: ignore[reportInvalidTypeForm]
_Array3ND: TypeAlias = onp.Array[
    tuple[int, int, int, *tuple[Any, ...]], _ScalarT
]  # pyright: ignore[reportInvalidTypeForm]
...
class multi_rv_generic(rng_mixin):
    ...
    def _get_random_state(
        self, /, random_state: onp.random.ToRNG | None
    ) -> onp.random.RNG: ...
...
class multivariate_normal_gen(multi_rv_generic):
    ...
    #
    def entropy(
        self, /, mean: onp.ToFloat1D | None = None, cov: _AnyCov = 1
    ) -> np.float64: ...
    def fit(
        self,
        /,
...
class multivariate_normal_frozen(multi_rv_frozen[multivariate_normal_gen]):
    ...
    @overload
    def rvs(
        self, /, size: int = 1, random_state: onp.random.ToRNG | None = None
    ) -> _ScalarOrArray_f8: ...
    @overload
    def rvs(
        self, /, size: tuple[int, ...], random_state: onp.random.ToRNG | None = None
    ) -> onp.ArrayND[np.float64]: ...
...
class matrix_normal_frozen(multi_rv_frozen[matrix_normal_gen]):
    ...
    @overload
    def rvs(
        self, /, size: Literal[1] = 1, random_state: onp.random.ToRNG | None = None
    ) -> onp.Array2D[np.float64]: ...
    @overload
    def rvs(
        self, /, size: int, random_state: onp.random.ToRNG | None = None
    ) -> _Array2ND[np.float64]: ...
...
class dirichlet_gen(multi_rv_generic):
    def __call__(
        self, /, alpha: onp.ToFloat1D, seed: onp.random.ToRNG | None = None
    ) -> dirichlet_frozen: ...
    def logpdf(
        self, /, x: onp.ToFloatND, alpha: onp.ToFloat1D
    ) -> _ScalarOrArray_f8: ...
...
class dirichlet_frozen(multi_rv_frozen[dirichlet_gen]):
    ...
    @overload
    def rvs(
        self, /, size: tuple[()], random_state: onp.random.ToRNG | None = None
    ) -> onp.Array1D[np.float64]: ...
    @overload
    def rvs(
        self,
...
class wishart_gen(multi_rv_generic):
    ...
    #
    def logpdf(
        self, /, x: onp.ToFloatND, df: onp.ToFloat, scale: _ToFloatMax2D
    ) -> _ScalarOrArray_f8: ...
    def pdf(
        self, /, x: onp.ToFloatND, df: onp.ToFloat, scale: _ToFloatMax2D
    ) -> _ScalarOrArray_f8: ...
    ...
    #
    def mean(
        self, /, df: onp.ToFloat, scale: _ToFloatMax2D
    ) -> np.float64 | onp.Array2D[np.float64]: ...
...
class multinomial_gen(multi_rv_generic):
    ...
    #
    def logpmf(
        self, /, x: onp.ToFloatND, n: onp.ToJustIntND, p: onp.ToJustFloatND
    ) -> _ScalarOrArray_f8: ...
    def pmf(
        self, /, x: onp.ToFloatND, n: onp.ToJustIntND, p: onp.ToJustFloatND
    ) -> _ScalarOrArray_f8: ...
    ...
    def entropy(
        self, /, n: onp.ToJustIntND, p: onp.ToJustFloatND
    ) -> _ScalarOrArray_f8: ...
...
class _group_rv_gen_mixin(Generic[_RVF_co, _ScalarT_co]):
    ...
    def __call__(
        self, /, dim: int | None = None, seed: onp.random.ToRNG | None = None
    ) -> _RVF_co: ...
    ...
    @overload
    def rvs(
        self, /, dim: int, size: int, random_state: onp.random.ToRNG | None = None
    ) -> _Array2ND[_ScalarT_co]: ...
...
class _group_rv_frozen_mixin(Generic[_ScalarT_co]):
    ...
    @overload
    def rvs(
        self, /, size: Literal[0, 1] = 1, random_state: onp.random.ToRNG | None = None
    ) -> onp.Array2D[_ScalarT_co]: ...
    @overload
    def rvs(
        self, /, size: int, random_state: onp.random.ToRNG | None = None
...
class special_ortho_group_gen(
    _group_rv_gen_mixin[special_ortho_group_frozen], multi_rv_generic
): ...
...
class unitary_group_gen(
    _group_rv_gen_mixin[unitary_group_frozen, np.complex128], multi_rv_generic
): ...
...
class multivariate_hypergeom_gen(multi_rv_generic):
    ...
    def pmf(
        self, /, x: onp.ToFloatND, m: onp.ToIntND, n: onp.ToJustInt | onp.ToJustIntND
    ) -> _ScalarOrArray_f8: ...
    def mean(
        self, /, m: onp.ToIntND, n: onp.ToJustInt | onp.ToJustIntND
    ) -> _Array1ND: ...
    def var(
        self, /, m: onp.ToIntND, n: onp.ToJustInt | onp.ToJustIntND
    ) -> _Array1ND: ...
...
class random_table_gen(multi_rv_generic):
    ...
    #
    def logpmf(
        self, /, x: onp.ToFloatND, row: onp.ToJustIntND, col: onp.ToJustIntND
    ) -> _ScalarOrArray_f8: ...
    def pmf(
        self, /, x: onp.ToFloatND, row: onp.ToJustIntND, col: onp.ToJustIntND
    ) -> _ScalarOrArray_f8: ...
    ...
    #
    def mean(
        self, /, row: onp.ToJustIntND, col: onp.ToJustIntND
    ) -> onp.Array2D[np.float64]: ...
...
class dirichlet_multinomial_gen(multi_rv_generic):
    ...
    def logpmf(
        self, /, x: onp.ToIntND, alpha: onp.ToFloatND, n: onp.ToJustIntND
    ) -> _ScalarOrArray_f8: ...
    def pmf(
        self, /, x: onp.ToIntND, alpha: onp.ToFloatND, n: onp.ToJustIntND
    ) -> _ScalarOrArray_f8: ...
...
class vonmises_fisher_gen(multi_rv_generic):
    ...
    def logpdf(
        self, /, x: onp.ToFloatND, mu: onp.ToFloat1D | None = None, kappa: int = 1
    ) -> _ScalarOrArray_f8: ...
    def pdf(
        self, /, x: onp.ToFloatND, mu: onp.ToFloat1D | None = None, kappa: int = 1
    ) -> _ScalarOrArray_f8: ...
    def entropy(
        self, /, mu: onp.ToFloat1D | None = None, kappa: int = 1
    ) -> np.float64: ...
    def rvs(
        self,
        /,
...
class normal_inverse_gamma_frozen(multi_rv_frozen[normal_inverse_gamma_gen]):
    ...
    def logpdf(
        self, /, x: onp.ToFloat | onp.ToFloatND, s2: onp.ToFloat | onp.ToFloatND
    ) -> _ScalarOrArray_f8: ...
    def pdf(
        self, /, x: onp.ToFloat | onp.ToFloatND, s2: onp.ToFloat | onp.ToFloatND
    ) -> _ScalarOrArray_f8: ...
