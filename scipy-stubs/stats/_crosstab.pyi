...
@overload
def crosstab(
    *args: Sequence[bool], levels: Sequence[bool] | None = None, sparse: bool = False
...
def crosstab(
    *args: Sequence[complex],
    ...
    CrosstabResult[np.complex128]
    | CrosstabResult[np.float64]
    | CrosstabResult[np.int_]
    | CrosstabResult[np.bool_]
): ...
@overload
def crosstab(
...
@overload
def crosstab(
    *args: Sequence[str], levels: Sequence[str] | None = None, sparse: bool = False
