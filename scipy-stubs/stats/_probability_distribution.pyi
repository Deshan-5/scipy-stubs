...
_CMomentMethod: TypeAlias = (
    L["formula", "transform", "quadrature", "cache", "normalize"] | None
)
_SMomentMethod: TypeAlias = (
    L["formula", "transform", "general", "cache", "normalize"] | None
)
_EntropyMethod: TypeAlias = L["formula", "logexp", "quadrature"] | None
_PXFMethod: TypeAlias = L["formula", "logexp"] | None
_CDFMethod: TypeAlias = (
    L["formula", "logexp", "complement", "quadrature", "subtraction"] | None
)
_CCDFMethod: TypeAlias = (
    L["formula", "logexp", "complement", "quadrature", "addition"] | None
)
...
class _ProbabilityDistribution(Generic[_XT_co], metaclass=abc.ABCMeta):
    ...
    def support(
        self, /
    ) -> tuple[_XT_co | onp.ArrayND[_XT_co], _XT_co | onp.ArrayND[_XT_co]]: ...
    @abc.abstractmethod
    ...
    def sample(
        ...
        *,
        ...
        rng: QMCEngine | onp.random.ToRNG | None,
    ...
    @abc.abstractmethod
    def variance(
        self, /, *, method: _CMomentMethod
    ) -> _XT_co | onp.ArrayND[_XT_co]: ...
    @abc.abstractmethod
    ...
    @abc.abstractmethod
    def moment(
        self, /, order: onp.ToInt, kind: L["raw"], *, method: _RMomentMethod
    ) -> _Float | _FloatND: ...
    @overload
    @abc.abstractmethod
    def moment(
        self, /, order: onp.ToInt, kind: L["central"], *, method: _CMomentMethod
    ) -> _Float | _FloatND: ...
    @overload
    @abc.abstractmethod
    def moment(
        self, /, order: onp.ToInt, kind: L["standardized"], *, method: _SMomentMethod
    ) -> _Float | _FloatND: ...
    ...
    @abc.abstractmethod
    def logentropy(
        self, /, *, method: _EntropyMethod
    ) -> _Complex | onp.ArrayND[_Complex]: ...
    ...
    #
    def pmf(
        self, x: _ToFloat0ND, /, *, method: _PXFMethod = None
    ) -> _Float | _FloatND: ...
    def logpmf(
        self, x: _ToFloat0ND, /, *, method: _PXFMethod = None
    ) -> _Float | _FloatND: ...
    ...
    @abc.abstractmethod
    def cdf(
        self, x: _ToFloat0ND, y: _ToFloat0ND | None, /, *, method: _CDFMethod
    ) -> _Float | _FloatND: ...
    @abc.abstractmethod
    def icdf(self, p: _ToFloat0ND, /, *, method: _ICDFMethod) -> _Float | _FloatND: ...
    @abc.abstractmethod
    def ccdf(
        self, x: _ToFloat0ND, y: _ToFloat0ND | None, /, *, method: _CCDFMethod
    ) -> _Float | _FloatND: ...
    @abc.abstractmethod
    ...
    @abc.abstractmethod
    def ilogcdf(
        self, logp: _ToFloat0ND, /, *, method: _ICDFMethod
    ) -> _Float | _FloatND: ...
    @abc.abstractmethod
    def logccdf(
        self, x: _ToFloat0ND, y: _ToFloat0ND | None, /, *, method: _CCDFMethod
