...
class HessianUpdateStrategy(Protocol):
    ...
    def update(
        self, /, delta_x: onp.Array1D[np.float64], delta_grad: onp.Array1D[np.float64]
    ) -> None: ...
...
class SR1(FullHessianUpdateStrategy):
    ...
    def __init__(
        self, /, min_denominator: float = 1e-08, init_scale: _ToInitScale = "auto"
    ) -> None: ...
