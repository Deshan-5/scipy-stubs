...
def _get_densest(
    A: onp.Array2D[_NumberT], eligibleRows: onp.Array1D[np.bool_]
) -> np.intp: ...
...
#
def bg_update_dense(
    plu: tuple[onp.Array1D[_NumberT], onp.Array1D[_NumberT2]],
    perm_r: onp.Array1D[np.intp],
    v: onp.Array1D[npc.number],
    j: int,
...
def _remove_redundancy_id(
    A: onp.Array2D[_NumberT],
    rhs: onp.Array1D[_NumberT2],
    rank: int | None = None,
