...
_FunConstr: TypeAlias = Callable[
    [onp.Array1D[np.float64]], _Tuple2[onp.Array1D[np.float64]]
]
_FunJac: TypeAlias = Callable[
    [onp.Array1D[np.float64]], _Tuple2[onp.Array2D[np.float64] | csr_matrix]
]
...
class CanonicalConstraint:
    ...
    def concatenate(
        cls,
        canonical_constraints: _PreparedConstraints,
