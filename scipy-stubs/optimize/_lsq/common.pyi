...
def intersect_trust_region(
    x: onp.ToFloat1D, s: onp.ToFloatND, Delta: onp.ToFloat
) -> tuple[_Float, _Float]: ...
def solve_trust_region_2d(
    B: onp.ToFloat2D, g: onp.ToFloat1D, Delta: onp.ToFloat
) -> tuple[_Float1D, bool]: ...
...
def step_size_to_bound(
    x: onp.ToFloat1D, s: onp.ToFloat1D, lb: onp.ToFloat1D, ub: onp.ToFloat1D
) -> tuple[_Float, _Int1D]: ...
def find_active_constraints(
    x: onp.ToFloat1D, lb: onp.ToFloat1D, ub: onp.ToFloat1D, rtol: onp.ToFloat = 1e-10
) -> _Int1D: ...
def make_strictly_feasible(
    x: onp.ToFloat1D, lb: onp.ToFloat1D, ub: onp.ToFloat1D, rstep: onp.ToFloat = 1e-10
) -> _Float1D: ...
def CL_scaling_vector(
    x: onp.ToFloat1D, g: onp.ToFloat1D, lb: onp.ToFloat1D, ub: onp.ToFloat1D
) -> tuple[_Float1D, _Float1D]: ...
def reflective_transformation(
    y: onp.ToFloat1D, lb: onp.ToFloat1D, ub: onp.ToFloat1D
) -> tuple[_Float1D, _Float1D]: ...
...
def compute_jac_scale(
    J: _ToMatrix, scale_inv_old: onp.ToFloat | onp.ToFloat2D | None = None
...
def scale_for_robust_loss_function(
    J: _ToMatrix, f: _T, rho: onp.ToFloat1D
) -> tuple[_ToMatrix, _T]: ...
