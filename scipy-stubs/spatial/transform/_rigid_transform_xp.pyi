...
def from_matrix(
    matrix: _ArrayT, normalize: bool = True, copy: bool = True
) -> _ArrayT: ...
...
def _create_transformation_matrix(
    translations: _ArrayT, rotation_matrices: _ArrayT
) -> _ArrayT: ...
...
def _normalize_dual_quaternion(
    real_part: _ArrayT, dual_part: _ArrayT
) -> tuple[_ArrayT, _ArrayT]: ...
