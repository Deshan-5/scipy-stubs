...
def from_matrix(
    matrix: _f64_3d, normalize: _bint = True, copy: _bint = True
) -> _f64_3d: ...
...
@overload
def from_dual_quat(
    dual_quat: onp.ToFloatStrict1D, *, scalar_first: _bint = False
) -> _f64_2d: ...
@overload
def from_dual_quat(
    dual_quat: onp.ToFloatStrict2D, *, scalar_first: _bint = False
) -> _f64_3d: ...
...
def apply(
    matrix: _f64_3d,
    vector: onp.ToFloatStrict1D | onp.ToFloatStrict2D,
    inverse: _bint = False,
) -> _f64_2d: ...
...
def _create_transformation_matrix(
    translations: _f64_1d | _f64_2d,
    rotation_matrices: _f64_2d | _f64_3d,
    single: Literal[True, 1],
) -> _f64_2d: ...
@overload
def _create_transformation_matrix(
    translations: _f64_1d | _f64_2d,
    rotation_matrices: _f64_2d | _f64_3d,
    single: Literal[False, 0],
) -> _f64_3d: ...
