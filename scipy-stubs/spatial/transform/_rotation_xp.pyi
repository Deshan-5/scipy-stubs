...
def from_davenport(
    axes: _ArrayT, order: str, angles: _ArrayT | float, degrees: bool = False
) -> _ArrayT: ...
def as_quat(
    quat: _ArrayT, canonical: bool = False, *, scalar_first: bool = False
) -> _ArrayT: ...
def as_matrix(quat: _ArrayT) -> _ArrayT: ...
def as_rotvec(quat: _ArrayT, degrees: bool = False) -> _ArrayT: ...
def as_mrp(quat: _ArrayT) -> _ArrayT: ...
def as_euler(
    quat: _ArrayT, seq: str, degrees: bool = False, *, suppress_warnings: bool = False
) -> _ArrayT: ...
def as_davenport(
    quat: _ArrayT,
    axes: _ArrayT,
...
def approx_equal(
    quat: _ArrayT, other: _ArrayT, atol: float | None = None, degrees: bool = False
) -> Incomplete: ...
def mean(
    quat: _ArrayT,
...
@overload
def reduce(
    quat: _ArrayT, left: None = None, right: None = None
) -> tuple[_ArrayT, None, None]: ...
@overload
def reduce(
    quat: _ArrayT, left: _ArrayT, right: _ArrayT | None = None
) -> tuple[_ArrayT, _ArrayT, _ArrayT]: ...
@overload
def reduce(
    quat: _ArrayT, left: _ArrayT | None, right: _ArrayT
) -> tuple[_ArrayT, _ArrayT, _ArrayT]: ...
@overload
def reduce(
    quat: _ArrayT, left: _ArrayT | None = None, *, right: _ArrayT
) -> tuple[_ArrayT, _ArrayT, _ArrayT]: ...

#
def apply(quat: _ArrayT, points: _ArrayT, inverse: bool = False) -> _ArrayT: ...
def setitem(
    quat: _ArrayT, value: _ArrayT, indexer: int | slice | EllipsisType | None
) -> _ArrayT: ...
def align_vectors(
    a: _ArrayT,
    b: _ArrayT,
...
def _align_vectors(
    a: _ArrayT, b: _ArrayT, weights: _ArrayT
) -> tuple[_ArrayT, _ArrayT, _ArrayT]: ...
...
def _elementary_quat_compose(
    axes: list[int], angles: _ArrayT, intrinsic: bool
) -> _ArrayT: ...
def _make_elementary_quat(
    axis: int, angle: _ArrayT, device: object, xp: ModuleType
) -> _ArrayT: ...
def _get_angles(
    extrinsic: bool,
    symmetric: bool,
