...
def normalize_dual_quaternion(
    dual_quat: onp.ArrayND[np.float64],
) -> onp.ArrayND[np.float64]: ...
def _create_transformation_matrix(
    translations: onp.ToFloat1D | onp.ToFloat2D,
    rotation_matrices: onp.ToFloat2D | onp.ToFloat3D,
    single: bool,
...
class RigidTransform:
    ...
    def from_translation(
        translation: onp.ToFloat1D | onp.ToFloat2D,
    ) -> RigidTransform: ...
    @staticmethod
    def from_components(
        translation: onp.ToFloat1D | onp.ToFloat2D, rotation: Rotation
    ) -> RigidTransform: ...
    @staticmethod
    def from_exp_coords(
        exp_coords: onp.ToFloat1D | onp.ToFloat2D,
    ) -> RigidTransform: ...
    @staticmethod
    def from_dual_quat(
        dual_quat: onp.ToFloat1D | onp.ToFloat2D, *, scalar_first: bool = False
    ) -> RigidTransform: ...
    @staticmethod
    def identity(
    ...
    def __init__(
        self,
        /,
        matrix: onp.ToFloat2D | onp.ToFloat3D,
        normalize: bool = True,
        copy: bool = True,
    ) -> None: ...
    ...
    def as_matrix(
        self, /
    ) -> onp.ArrayND[np.float64, tuple[int, int] | tuple[int, int, int]]: ...
    def as_components(
        self, /
    ) -> tuple[onp.ArrayND[np.float64, tuple[int] | tuple[int, int]], Rotation]: ...
    def as_exp_coords(
        self, /
    ) -> onp.ArrayND[np.float64, tuple[int] | tuple[int, int]]: ...
    def as_dual_quat(
        self, /, *, scalar_first: bool = False
    ) -> onp.ArrayND[np.float64, tuple[int] | tuple[int, int]]: ...
    def inv(self, /) -> Self: ...
    def mean(
        self,
    ...
    @overload
    def apply(
        self, /, vector: onp.ToFloatStrict1D, inverse: bool = False
    ) -> onp.Array1D[np.float64]: ...
    @overload
    def apply(
        self, /, vector: onp.ToFloatStrict2D, inverse: bool = False
