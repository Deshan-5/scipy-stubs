...
class _Qhull:
    ...
    def add_points(
        self, /, points: onp.ToFloat2D, interior_point: onp.ToFloat1D | None = None
    ) -> None: ...
...
class Delaunay(_QhullUser[_Qhull]):
    ...
    def find_simplex(
        self, /, xi: onp.ToFloatND, bruteforce: bool = False, tol: float | None = None
    ) -> _IntCND: ...
...
class HalfspaceIntersection(_QhullUser):
    ...
    def add_halfspaces(
        self, /, halfspaces: onp.ToFloat2D, restart: bool = False
    ) -> None: ...
