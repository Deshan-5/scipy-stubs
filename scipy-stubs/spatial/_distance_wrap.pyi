...
def cdist_braycurtis_double_wrap(
    XA: _DoubleND, XB: _DoubleND, dm: _DoubleND
) -> float: ...
...
def cdist_hamming_double_wrap(
    XA: _DoubleND, XB: _DoubleND, dm: _DoubleND, w: _DoubleND
) -> float: ...
...
def cdist_mahalanobis_double_wrap(
    XA: _DoubleND, XB: _DoubleND, dm: _DoubleND, VI: _DoubleND
) -> float: ...
def cdist_minkowski_double_wrap(
    XA: _DoubleND, XB: _DoubleND, dm: _DoubleND, p: float
) -> float: ...
def cdist_seuclidean_double_wrap(
    XA: _DoubleND, XB: _DoubleND, dm: _DoubleND, V: _DoubleND
) -> float: ...
def cdist_sqeuclidean_double_wrap(
    XA: _DoubleND, XB: _DoubleND, dm: _DoubleND
) -> float: ...
def cdist_weighted_chebyshev_double_wrap(
    XA: _DoubleND, XB: _DoubleND, dm: _DoubleND, w: _DoubleND
) -> float: ...
def cdist_weighted_minkowski_double_wrap(
    XA: _DoubleND, XB: _DoubleND, dm: _DoubleND, p: float, w: _DoubleND
) -> float: ...

#
def cdist_dice_bool_wrap(XA: _BoolND, XB: _BoolND, dm: _DoubleND) -> float: ...
def cdist_hamming_bool_wrap(
    XA: _BoolND, XB: _BoolND, dm: _DoubleND, w: _DoubleND
) -> float: ...
def cdist_jaccard_bool_wrap(XA: _BoolND, XB: _BoolND, dm: _DoubleND) -> float: ...
def cdist_rogerstanimoto_bool_wrap(
    XA: _BoolND, XB: _BoolND, dm: _DoubleND
) -> float: ...
...
def pdist_mahalanobis_double_wrap(
    X: _Double2D, dm: _Double2D, VI: _Double2D
) -> float: ...
def pdist_minkowski_double_wrap(X: _Double2D, dm: _Double2D, p: float) -> float: ...
def pdist_seuclidean_double_wrap(
    X: _Double2D, dm: _Double2D, V: _DoubleND
) -> float: ...
def pdist_sqeuclidean_double_wrap(X: _Double2D, dm: _Double2D, /) -> float: ...
def pdist_weighted_chebyshev_double_wrap(
    X: _Double2D, dm: _Double2D, w: _DoubleND
) -> float: ...
def pdist_weighted_minkowski_double_wrap(
    X: _Double2D, dm: _Double2D, p: float, w: _DoubleND
) -> float: ...
...
def to_squareform_from_vector_wrap(
    M: _Double2D | _Bool2D, v: _Double1D | _Bool1D, /
) -> None: ...
