...
_SafeInexactT = TypeVar(
    "_SafeInexactT", bound=np.float32 | np.float64 | np.complex64 | np.complex128
)
...
_SystemZPK: TypeAlias = tuple[
    onp.Array1D[_InexactT], onp.Array1D[_InexactT], float | np.float64
]
_SystemSS: TypeAlias = tuple[
...
_DiscretizeMethod: TypeAlias = Literal[
    "gbt", "bilinear", "euler", "backward_diff", "foh", "impulse", "zoh"
]
...
@overload
def zpk2ss(
    z: onp.ToFloat1D, p: onp.ToFloat1D, k: onp.ToFloat
) -> _SystemSS[npc.floating]: ...
@overload
...
def cont2discrete(
    system: TransferFunctionContinuous[_SafeFloatT],
    dt: float,
...
@overload  # lti
def cont2discrete(
    system: lti[_SafeInexactT, _SafeFloatT],
    dt: float,
    method: _DiscretizeMethod = "zoh",
    alpha: float | None = None,
...
@overload  # (~f64; 4)
def cont2discrete(
    system: _Tuple4[onp.ToInt2D | onp.ToJustFloat64_2D],
    dt: float,
    method: _DiscretizeMethod = "zoh",
    alpha: float | None = None,
...
@overload  # (~f16; 4)
def cont2discrete(
    system: _Tuple4[onp.ToJustFloat16_2D],
    dt: float,
    method: _DiscretizeMethod = "zoh",
    alpha: float | None = None,
...
@overload  # (~f32; 4)
def cont2discrete(
    system: _Tuple4[onp.ToJustFloat32_2D],
    dt: float,
    method: _DiscretizeMethod = "zoh",
    alpha: float | None = None,
...
@overload  # (~c128; 4)
def cont2discrete(
    system: _Tuple4[onp.ToJustComplex128_2D],
    dt: float,
    method: _DiscretizeMethod = "zoh",
    alpha: float | None = None,
...
@overload  # (~c64; 4)
def cont2discrete(
    system: _Tuple4[onp.ToJustComplex64_2D],
    dt: float,
    method: _DiscretizeMethod = "zoh",
    alpha: float | None = None,
