...
_ZPK = TypeAliasType(
    "_ZPK",
    tuple[onp.Array1D[_SCT_z], onp.Array1D[_SCT_p], _SCT_k],
    type_params=(_SCT_z, _SCT_p, _SCT_k),
)

_SCT_ba = TypeVar("_SCT_ba", bound=npc.inexact, default=np.float64)
_Ba1D = TypeAliasType(
    "_Ba1D", tuple[onp.Array1D[_SCT_ba], onp.Array1D[_SCT_ba]], type_params=(_SCT_ba,)
)
_Ba2D = TypeAliasType(
    "_Ba2D", tuple[onp.Array2D[_SCT_ba], onp.Array1D[_SCT_ba]], type_params=(_SCT_ba,)
)
_BaND = TypeAliasType(
    "_BaND", tuple[onp.ArrayND[_SCT_ba], onp.Array1D[_SCT_ba]], type_params=(_SCT_ba,)
)

# excludes `float16` and `longdouble`
_ToFloat: TypeAlias = float | np.float32 | np.float64 | npc.integer
_ToFloat1D: TypeAlias = (
    Sequence[_ToFloat] | onp.CanArrayND[np.float32 | np.float64 | npc.integer]
)
...
_BType: TypeAlias = (
    _BType0
    | L[
        "band", "pass", "bp", "bands", "stop", "bs", "low", "lp", "l", "high", "hp", "h"
    ]
)
...
def freqs(
    ...
    plot: (
        Callable[[_Float1D, _Complex1D], object]
        | Callable[[_Complex1D, _Complex1D], object]
        | None
    ) = None,
...
@overload  # c128
def tf2zpk(
    b: onp.ToJustComplex128_1D, a: onp.ToJustComplex128_1D
) -> _ZPK[np.complex128, np.complex128, np.float64]: ...
@overload  # f32
def tf2zpk(
    b: onp.ToJustFloat32_1D, a: onp.ToJustFloat32_1D
) -> _ZPK[np.float32 | np.complex64, np.complex64, np.float32]: ...
@overload  # c64
def tf2zpk(
    b: onp.ToJustComplex64_1D, a: onp.ToJustComplex64_1D
) -> _ZPK[np.complex64, np.complex64, np.float32]: ...
@overload  # fallback
def tf2zpk(
    b: onp.ToComplex1D, a: onp.ToComplex1D
) -> _ZPK[Incomplete, Incomplete, Incomplete]: ...
...
@overload  # ~f64, ~f64
def normalize(
    b: onp.ToIntND | onp.ToJustFloat64_ND, a: onp.ToIntND | onp.ToJustFloat64_ND
) -> _BaND[np.float64]: ...
@overload  # +c128, ~c128
def normalize(
    b: onp.ToComplex128_ND, a: onp.ToJustComplex128_ND
) -> _BaND[np.complex128]: ...
@overload  # ~c128, +c128
def normalize(
    b: onp.ToJustComplex128_ND, a: onp.ToComplex128_ND
) -> _BaND[np.complex128]: ...
@overload  # ~T, ~T
def normalize(
    b: onp.ArrayND[_AnyInexactT], a: onp.ArrayND[_AnyInexactT]
) -> _BaND[_AnyInexactT]: ...
@overload  # fallback
...
@overload  # T: inexact
def sos2tf(
    sos: onp.Array2D[_InexactT],
) -> tuple[onp.Array1D[_InexactT], onp.Array1D[_InexactT]]: ...
@overload  # fallback
...
@overload  # f64
def sos2zpk(
    sos: onp.ToInt2D | onp.ToJustFloat64_2D,
) -> _ZPK[np.complex128, np.complex128, np.float64]: ...
@overload  # c128
def sos2zpk(
    sos: onp.ToJustComplex128_2D,
) -> _ZPK[np.complex128, np.complex128, np.complex128]: ...
@overload  # f32
def sos2zpk(
    sos: onp.ToJustFloat32_2D,
) -> _ZPK[np.complex128, np.complex128, np.float32]: ...
@overload  # c64
def sos2zpk(
    sos: onp.ToJustComplex64_2D,
) -> _ZPK[np.complex128, np.complex128, np.complex64]: ...
@overload  # fallback
...
@overload  # +f64, +f64
def lp2lp(
    b: onp.ToFloat64_ND, a: onp.ToFloat64_1D, wo: float = 1.0
) -> tuple[_Float1D, _Float1D]: ...
@overload  # +c128, ~c128
def lp2lp(
    b: onp.ToComplex128_ND,
    a: onp.ToJustComplex64_1D | onp.ToJustComplex128_1D,
    wo: float = 1.0,
) -> tuple[_ComplexND, _Complex1D]: ...
@overload  # ~c128, +c128
def lp2lp(
    b: onp.ToJustComplex64_ND | onp.ToJustComplex128_ND,
...
@overload  # fallback
def lp2lp(
    b: onp.ToComplexND, a: onp.ToComplex1D, wo: float = 1.0
) -> tuple[onp.Array, onp.Array1D]: ...

# TODO: overloads
def lp2hp(
    b: onp.ToFloat1D, a: onp.ToFloat1D, wo: float = 1.0
) -> _Ba1D[np.float64 | Any]: ...
...
def bilinear_zpk(
    ...
    _ZPK[np.float64, npc.complexfloating]
    | _ZPK[np.longdouble, npc.complexfloating, np.longdouble]
): ...
@overload
def bilinear_zpk(
...
@overload
def buttap(
    N: int, *, xp: None = None, device: None = None
) -> tuple[_Float1D, _Complex1D, L[1]]: ...
@overload
def buttap(
    N: int, *, xp: ModuleType, device: object = None
) -> tuple[Incomplete, Incomplete, L[1]]: ...

#
@overload
def cheb1ap(
    N: int, rp: float, *, xp: None = None, device: None = None
) -> tuple[_Float1D, _Complex1D, float]: ...
@overload
def cheb1ap(
    N: int, rp: float, *, xp: ModuleType, device: object = None
) -> tuple[Incomplete, Incomplete, float]: ...

#
@overload
def cheb2ap(
    N: int, rs: float, *, xp: None = None, device: None = None
) -> tuple[_Complex1D, _Complex1D, float]: ...
@overload
def cheb2ap(
    N: int, rs: float, *, xp: ModuleType, device: object = None
) -> tuple[Incomplete, Incomplete, float]: ...

#
@overload
def ellipap(
    N: int, rp: float, rs: float, *, xp: None = None, device: None = None
) -> tuple[_Complex1D, _Complex1D, float]: ...
@overload
def ellipap(
    N: int, rp: float, rs: float, *, xp: ModuleType, device: object = None
) -> tuple[Incomplete, Incomplete, float]: ...

#
@overload
def besselap(
    N: int, norm: _Norm = "phase", *, xp: None = None, device: None = None
) -> tuple[_Float1D, _Complex1D, float]: ...
@overload
def besselap(
    N: int, norm: _Norm = "phase", *, xp: ModuleType, device: object = None
) -> tuple[Incomplete, Incomplete, float]: ...

#
@overload
def iirnotch(
    w0: float, Q: float, fs: float = 2.0, *, xp: None = None, device: None = None
) -> _Ba1D: ...
@overload
def iirnotch(
    w0: float, Q: float, fs: float = 2.0, *, xp: ModuleType, device: object = None
