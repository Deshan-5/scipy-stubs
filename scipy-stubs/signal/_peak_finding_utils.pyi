...
def _local_maxima_1d(
    x: _Array_f8_1d,
) -> tuple[_Array_n_1d, _Array_n_1d, _Array_n_1d]: ...
def _select_by_peak_distance(
    peaks: _Array_n_1d, priority: _Array_f8_1d, distance: np.float64
) -> _Array_b_1d: ...
def _peak_prominences(
    x: _Array_f8_1d, peaks: _Array_n_1d, wlen: np.intp
) -> tuple[_Array_f8_1d, _Array_n_1d, _Array_n_1d]: ...
def _peak_widths(
    x: _Array_f8_1d,
    peaks: _Array_n_1d,
