...
@overload
def symiirorder1_ic(
    signal: _FloatND, c0: _ToFloat, z1: _ToFloat, precision: _ToFloat
) -> _FloatND: ...
@overload
def symiirorder1_ic(
    signal: _ComplexND, c0: _ToFloat, z1: _ToFloat, precision: _ToFloat
) -> _ComplexND: ...
@overload
def symiirorder1_ic(
    signal: _InexactND, c0: _ToFloat, z1: _ToFloat, precision: _ToFloat
) -> _InexactND: ...

#
def symiirorder2_ic_fwd(
    signal: _FloatND, r: _ToFloat, omega: _ToFloat, precision: _ToFloat
) -> _FloatND: ...
