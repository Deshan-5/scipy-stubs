...
def correlate(
    in1: object, in2: object, mode: object = "full", method: object = "auto"
) -> object: ...
@deprecated("will be removed in SciPy v2.0.0")
def correlation_lags(
    in1_len: object, in2_len: object, mode: object = "full"
) -> object: ...
@deprecated("will be removed in SciPy v2.0.0")
def fftconvolve(
    in1: object, in2: object, mode: object = "full", axes: object = None
) -> object: ...
@deprecated("will be removed in SciPy v2.0.0")
def oaconvolve(
    in1: object, in2: object, mode: object = "full", axes: object = None
...
def choose_conv_method(
    in1: object, in2: object, mode: object = "full", measure: object = False
) -> object: ...
@deprecated("will be removed in SciPy v2.0.0")
def convolve(
    in1: object, in2: object, mode: object = "full", method: object = "auto"
...
@deprecated("will be removed in SciPy v2.0.0")
def lfilter(
    b: object, a: object, x: object, axis: object = -1, zi: object = None
) -> object: ...
@deprecated("will be removed in SciPy v2.0.0")
...
@deprecated("will be removed in SciPy v2.0.0")
def invres(
    r: object, p: object, k: object, tol: object = 1e-3, rtype: object = "avg"
) -> object: ...
@deprecated("will be removed in SciPy v2.0.0")
def residue(
    b: object, a: object, tol: object = 1e-3, rtype: object = "avg"
) -> object: ...
@deprecated("will be removed in SciPy v2.0.0")
def residuez(
    b: object, a: object, tol: object = 1e-3, rtype: object = "avg"
