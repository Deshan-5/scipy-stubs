...
_DualMatrixLike = TypeAliasType(
    "_DualMatrixLike", _T | _ScalarT | _spbase[_ScalarT], type_params=(_T, _ScalarT)
)
...
_StackedSparseMatrix: TypeAlias = (
    coo_matrix[_ScalarT] | csc_matrix[_ScalarT] | csr_matrix[_ScalarT]
)
...
class spmatrix(Generic[_ScalarT_co]):
    ...
    def __mul__(
        self: spmatrix, other: _DualArrayLike[bool, np.bool_], /
    ) -> onp.Array2D[_ScalarT_co]: ...
    @overload  # spmatrix[-Int], other: sparse +Int
    def __mul__(
        self: spmatrix[npc.number], other: _spbase[_ToInt8], /
    ) -> _SpMatrixOut[_ScalarT_co]: ...
    @overload  # spmatrix[-Int], other: array-like +Int
    def __mul__(
        self: spmatrix[npc.number], other: _DualArrayLike[bool, _ToInt8], /
    ) -> onp.Array2D[_ScalarT_co]: ...
    @overload  # spmatrix[-Float], other: sparse +Float
    def __mul__(
        self: spmatrix[npc.inexact], other: _spbase[_ToFloat32 | _ScalarT_co], /
    ) -> _SpMatrixOut[_ScalarT_co]: ...
    @overload  # spmatrix[-Float], other: array-like +Float
    def __mul__(
        self: spmatrix[npc.inexact], other: _DualArrayLike[int, _ToFloat32], /
    ) -> onp.Array2D[_ScalarT_co]: ...
    @overload  # spmatrix[-Complex], other: sparse +Complex
    def __mul__(
        self: spmatrix[npc.complexfloating],
        other: _spbase[_ToComplex64 | _ScalarT_co],
        /,
    ) -> _SpMatrixOut[_ScalarT_co]: ...
    @overload  # spmatrix[-Complex], other: array-like +Complex
    def __mul__(
        self: spmatrix[npc.complexfloating],
        other: _DualArrayLike[float, _ToComplex64],
        /,
    ) -> onp.Array2D[_ScalarT_co]: ...
    @overload  # spmatrix[+Bool], other: scalar- or matrix-like ~Int
    def __mul__(
        self: spmatrix[np.bool_], other: _DualMatrixLike[op.JustInt, npc.integer], /
    ) -> spmatrix[npc.integer]: ...
    @overload  # spmatrix[+Bool], other: array-like ~Int
    def __mul__(
        self: spmatrix[np.bool_], other: _DualArrayLike[op.JustInt, npc.integer], /
    ) -> onp.Array2D[npc.integer]: ...
    @overload  # spmatrix[+Int], other: scalar- or matrix-like ~Float
    def __mul__(
        self: spmatrix[_ToInt], other: _DualMatrixLike[op.JustFloat, npc.floating], /
    ...
    def __mul__(
        ...
        other: _DualMatrixLike[op.JustComplex, npc.complexfloating],
        /,
    ) -> spmatrix[npc.complexfloating]: ...
    @overload  # spmatrix[+Float], other: array-like ~Complex
    def __mul__(
        self: spmatrix[_ToFloat],
        other: _DualArrayLike[op.JustComplex, npc.complexfloating],
        /,
    ...
    @overload
    def asfptype(
        self: spmatrix[np.bool_ | npc.integer8 | npc.integer16], /
    ) -> spmatrix[np.float32]: ...
    @overload
    def asfptype(
    ...
    @overload
    def todense(
        self, /, order: L["C", "F"] | None, out: onp.ArrayND[_ScalarT]
    ) -> onp.Matrix[_ScalarT]: ...
    @overload
    def todense(
        self, /, order: L["C", "F"] | None = None, *, out: onp.ArrayND[_ScalarT]
    ) -> onp.Matrix[_ScalarT]: ...
