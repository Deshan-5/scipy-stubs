...
_NumberT_co = TypeVar(
    "_NumberT_co", bound=npc.number, default=np.float64 | Any, covariant=True
)
...
class _AProd(Generic[_NumberT_co]):
    ...
    def __init__(
        self, /, A: onp.ToArray2D[_NumberT_co] | _spbase[_NumberT_co, tuple[int, int]]
    ) -> None: ...
    def __call__(
        self,
        /,
...
def _svdp(
    A: (
        onp.ToArray2D[_NumberT]
        | _spbase[_NumberT, tuple[int, int]]
        | LinearOperator[_NumberT]
    ),
    k: int,
