...
_CXXArray: TypeAlias = (
    csr_array | csr_matrix | csc_array | csc_matrix | coo_array | coo_matrix
)
...
def maximum_bipartite_matching(
    graph: _CXXArray, perm_type: Literal["row", "column"] = "row"
) -> _IntVector: ...
def min_weight_full_bipartite_matching(
    biadjacency: _CXXArray, maximize: bool = False
