...
# bsr.h
def bsr_diagonal(
    a0: _i, a1: _i, a2: _i, a3: _i, a4: _i, a5: _I, a6: _I, a7: _T, a8: _T, /
) -> None: ...  # v iiiiiIIT*T
def bsr_tocsr(
    a0: _i, a1: _i, a2: _i, a3: _i, a4: _I, a5: _I, a6: _T, a7: _I, a8: _I, a9: _T, /
) -> None: ...  # v iiiiIIT*I*I*T
def bsr_scale_columns(
    a0: _i, a1: _i, a2: _i, a3: _i, a4: _I, a5: _I, a6: _T, a7: _T, /
) -> None: ...  # v iiiiII*TT
def bsr_scale_rows(
    a0: _i, a1: _i, a2: _i, a3: _i, a4: _I, a5: _I, a6: _T, a7: _T, /
) -> None: ...  # v iiiiII*TT
def bsr_sort_indices(
    a0: _i, a1: _i, a2: _i, a3: _i, a4: _I, a5: _I, a6: _T, /
) -> None: ...  # v iiii*I*I*T
def bsr_transpose(
    a0: _i, a1: _i, a2: _i, a3: _i, a4: _I, a5: _I, a6: _T, a7: _I, a8: _I, a9: _T, /
) -> None: ...  # v iiiiIIT*I*I*T
...
def bsr_matvec(
    a0: _i, a1: _i, a2: _i, a3: _i, a4: _I, a5: _I, a6: _T, a7: _T, a8: _T, /
) -> None: ...  # v iiiiIITT*T
def bsr_matvecs(
    a0: _i, a1: _i, a2: _i, a3: _i, a4: _i, a5: _I, a6: _I, a7: _T, a8: _T, a9: _T, /
) -> None: ...  # v iiiiiIITT*T
def bsr_elmul_bsr(
    a0: _i,
    a1: _i,
...
# csc.h
def csc_matvec(
    a0: _i, a1: _i, a2: _I, a3: _I, a4: _T, a5: _T, a6: _T, /
) -> None: ...  # v iiIITT*T
def csc_matvecs(
    a0: _i, a1: _i, a2: _i, a3: _I, a4: _I, a5: _T, a6: _T, a7: _T, /
) -> None: ...  # v iiiIITT*T

# csr.h
def csr_matmat_maxnnz(
    a0: _i, a1: _i, a2: _I, a3: _I, a4: _I, a5: _I, /
) -> np.int64: ...  # l iiIIII
def csr_matmat(
    a0: _i,
    a1: _i,
...
def csr_diagonal(
    a0: _i, a1: _i, a2: _i, a3: _I, a4: _I, a5: _T, a6: _T, /
) -> None: ...  # v iiiIIT*T
def csr_tocsc(
    a0: _i, a1: _i, a2: _I, a3: _I, a4: _T, a5: _I, a6: _I, a7: _T, /
) -> None: ...  # v iiIIT*I*I*T
def csr_tobsr(
    a0: _i, a1: _i, a2: _i, a3: _i, a4: _I, a5: _I, a6: _T, a7: _I, a8: _I, a9: _T, /
) -> None: ...  # v iiiiIIT*I*I*T
def csr_todense(
    a0: _i, a1: _i, a2: _I, a3: _I, a4: _I, a5: _T, /
) -> None: ...  # v iiIIT*T
def csr_matvec(
    a0: _i, a1: _i, a2: _I, a3: _I, a4: _T, a5: _T, a6: _T, /
) -> None: ...  # v iiIITT*T
...
def csr_scale_rows(
    a0: _i, a1: _i, a2: _I, a3: _I, a4: _T, a5: _T, /
) -> None: ...  # v iiII*TT
...
def csr_row_index(
    a0: _i, a1: _I, a2: _I, a3: _I, a4: _T, a5: _I, a6: _T, /
) -> None: ...  # v iIIIT*I*T
def csr_row_slice(
    a0: _i, a1: _i, a2: _i, a3: _I, a4: _I, a5: _T, a6: _I, a7: _T, /
) -> None: ...  # v iiiIIT*I*T
...
def csr_sample_values(
    a0: _i, a1: _i, a2: _I, a3: _I, a4: _T, a5: _i, a6: _I, a7: _I, a8: _T, /
) -> None: ...  # v iiIITiII*T
def csr_count_blocks(
    a0: _i, a1: _i, a2: _i, a3: _i, a4: _I, a5: _I, /
) -> int: ...  # i iiiiII
def csr_sample_offsets(
    a0: _i, a1: _i, a2: _I, a3: _I, a4: _i, a5: _I, a6: _I, a7: _I, /
) -> int: ...  # i iiIIiII*I
def csr_hstack(
    a0: _i, a1: _i, a2: _I, a3: _I, a4: _I, a5: _T, a6: _I, a7: _I, a8: _T, /
) -> None: ...  # v iiIIIT*I*I*T
...
def coo_todense(
    a0: _i, a1: _i, a2: _l, a3: _I, a4: _I, a5: _T, a6: _T, a7: _i, /
) -> None: ...  # v iilIIT*Ti
def coo_todense_nd(
    a0: _I, a1: _l, a2: _l, a3: _I, a4: _T, a5: _T, a6: _i, /
) -> None: ...  # v IllIT*Ti
def coo_matvec(
    a0: _l, a1: _I, a2: _I, a3: _T, a4: _T, a5: _T, /
) -> None: ...  # v lIITT*T
def coo_matvec_nd(
    a0: _l, a1: _l, a2: _I, a3: _I, a4: _T, a5: _T, a6: _T, /
) -> None: ...  # v llIITT*T
def coo_matmat_dense(
    a0: _l, a1: _l, a2: _I, a3: _I, a4: _T, a5: _T, a6: _T, /
) -> None: ...  # v llIITT*T
def coo_matmat_dense_nd(
    a0: _l, a1: _l, a2: _l, a3: _I, a4: _I, a5: _I, a6: _T, a7: _T, a8: _T, /
) -> None: ...  # v lllIIITT*T

# dia.h
def dia_tocsr(
    a0: _i, a1: _i, a2: _i, a3: _i, a4: _I, a5: _T, a6: _I, r0: _T, r1: _I, r2: _I, /
) -> int: ...  # i iiiiITI*T*I*I
def dia_matmat(
    a0: _i,
    a1: _i,
...
def dia_matvec(
    a0: _i, a1: _i, a2: _i, a3: _i, a4: _T, a5: _T, a6: _T, a7: _T, /
) -> None: ...  # v iiiiITT*T
def dia_matvecs(
    a0: _i, a1: _i, a2: _i, a3: _i, a4: _I, a5: _T, a6: _i, a7: _T, a8: _T, /
) -> None: ...  # v iiiiITiT*T
