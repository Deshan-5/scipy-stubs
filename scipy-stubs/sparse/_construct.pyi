...
_ToArray1D2D: TypeAlias = (
    onp.CanArray[tuple[int] | tuple[int, int], np.dtype[_SCT]] | Seq[_SCT | Seq[_SCT]]
)
...
_ToComplex1D2D: TypeAlias = (
    onp.CanArray[tuple[int] | tuple[int, int], np.dtype[_Numeric]] | _ComplexSeq1D2D
)
...
_ToMatsDiagUnknown: TypeAlias = Iterable[
    _spbase
    | onp.ArrayND[_Numeric]
    | complex
    | Seq[onp.ToComplex]
    | Seq[onp.ToComplex1D]
]
...
@overload
def expand_dims(
    A: sparray[_SCT, tuple[int]], /, *, axis: int = 0
) -> coo_array[_SCT, tuple[int, int]]: ...
@overload
def expand_dims(
    A: sparray[_SCT, tuple[int, int]], /, *, axis: int = 0
) -> coo_array[_SCT, tuple[int, int, int]]: ...
@overload
def expand_dims(
    A: sparray[_SCT, tuple[int, int, int]], /, *, axis: int = 0
) -> coo_array[_SCT, tuple[int, int, int, int]]: ...
...
@overload
def swapaxes(
    A: sparray[_SCT, _ShapeT], axis1: int, axis2: int
...
@overload
def permute_dims(
    A: sparray[_SCT, _ShapeT], axes: Seq[int] | None = None, copy: bool = False
) -> coo_array[_SCT, _ShapeT]: ...
@overload  # TODO(@jorenham): shape-typing for coo_matrix
def permute_dims(
    A: spmatrix[_SCT], axes: Seq[int] | None = None, copy: bool = False
) -> coo_matrix[_SCT]: ...
...
@overload
def spdiags(
    data: _ToArray1D2D[_SCT], diags: _Offsets, m: int, n: int, format: _FmtBSR
) -> bsr_matrix[_SCT]: ...
@overload
def spdiags(
    data: _ToArray1D2D[_SCT], diags: _Offsets, m: int, n: int, format: _FmtCOO
) -> coo_matrix[_SCT]: ...
@overload
def spdiags(
    data: _ToArray1D2D[_SCT], diags: _Offsets, m: int, n: int, format: _FmtCSC
) -> csc_matrix[_SCT]: ...
@overload
def spdiags(
    data: _ToArray1D2D[_SCT], diags: _Offsets, m: int, n: int, format: _FmtCSR
) -> csr_matrix[_SCT]: ...
@overload
def spdiags(
    data: _ToArray1D2D[_SCT], diags: _Offsets, m: int, n: int, format: _FmtDOK
) -> dok_matrix[_SCT]: ...
@overload
def spdiags(
    data: _ToArray1D2D[_SCT], diags: _Offsets, m: int, n: int, format: _FmtLIL
) -> lil_matrix[_SCT]: ...
...
def identity(
    n: int, dtype: _ToDType, format: _FmtDIA | None = None
...
@overload  # dtype: int-like, format: "bsr"
def eye_array(
    m: int, n: int | None = None, *, k: int = 0, dtype: onp.AnyIntDType, format: _FmtBSR
) -> bsr_array[np.int_]: ...
@overload  # dtype: int-like, format: "coo"
def eye_array(
    m: int, n: int | None = None, *, k: int = 0, dtype: onp.AnyIntDType, format: _FmtCOO
) -> _COOArray2D[np.int_]: ...
@overload  # dtype: int-like, format: "csc"
def eye_array(
    m: int, n: int | None = None, *, k: int = 0, dtype: onp.AnyIntDType, format: _FmtCSC
) -> csc_array[np.int_]: ...
@overload  # dtype: int-like, format: "csr"
def eye_array(
    m: int, n: int | None = None, *, k: int = 0, dtype: onp.AnyIntDType, format: _FmtCSR
) -> _CSRArray2D[np.int_]: ...
@overload  # dtype: int-like, format: "dok"
def eye_array(
    m: int, n: int | None = None, *, k: int = 0, dtype: onp.AnyIntDType, format: _FmtDOK
) -> _DOKArray2D[np.int_]: ...
@overload  # dtype: int-like, format: "lil"
def eye_array(
    m: int, n: int | None = None, *, k: int = 0, dtype: onp.AnyIntDType, format: _FmtLIL
) -> lil_array[np.int_]: ...
...
@overload  # dtype: <unknown>, format: "bsr"
def eye_array(
    m: int, n: int | None = None, *, k: int = 0, dtype: _ToDType, format: _FmtBSR
) -> bsr_array[Incomplete]: ...
@overload  # dtype: <unknown>, format: "coo"
def eye_array(
    m: int, n: int | None = None, *, k: int = 0, dtype: _ToDType, format: _FmtCOO
) -> _COOArray2D[Incomplete]: ...
@overload  # dtype: <unknown>, format: "csc"
def eye_array(
    m: int, n: int | None = None, *, k: int = 0, dtype: _ToDType, format: _FmtCSC
) -> csc_array[Incomplete]: ...
@overload  # dtype: <unknown>, format: "csr"
def eye_array(
    m: int, n: int | None = None, *, k: int = 0, dtype: _ToDType, format: _FmtCSR
) -> _CSRArray2D[Incomplete]: ...
@overload  # dtype: <unknown>, format: "dok"
def eye_array(
    m: int, n: int | None = None, *, k: int = 0, dtype: _ToDType, format: _FmtDOK
) -> _DOKArray2D[Incomplete]: ...
@overload  # dtype: <unknown>, format: "lil"
def eye_array(
    m: int, n: int | None = None, *, k: int = 0, dtype: _ToDType, format: _FmtLIL
...
def kron(
    A: _ToSpMatrix[_SCT], B: _ToSpMatrix[_SCT], format: _FmtBSR | None = None
) -> bsr_matrix[_SCT]: ...
@overload  # A: spmatrix or 2d array-like, B: spmatrix or 2d array-like, format: "coo"
def kron(
    A: _ToSpMatrix[_SCT], B: _ToSpMatrix[_SCT], format: _FmtCOO
) -> coo_matrix[_SCT]: ...
@overload  # A: spmatrix or 2d array-like, B: spmatrix or 2d array-like, format: "csc"
def kron(
    A: _ToSpMatrix[_SCT], B: _ToSpMatrix[_SCT], format: _FmtCSC
) -> csc_matrix[_SCT]: ...
@overload  # A: spmatrix or 2d array-like, B: spmatrix or 2d array-like, format: "csr"
def kron(
    A: _ToSpMatrix[_SCT], B: _ToSpMatrix[_SCT], format: _FmtCSR
) -> csr_matrix[_SCT]: ...
@overload  # A: spmatrix or 2d array-like, B: spmatrix or 2d array-like, format: "dia"
def kron(
    A: _ToSpMatrix[_SCT], B: _ToSpMatrix[_SCT], format: _FmtDIA
) -> dia_matrix[_SCT]: ...
@overload  # A: spmatrix or 2d array-like, B: spmatrix or 2d array-like, format: "dok"
def kron(
    A: _ToSpMatrix[_SCT], B: _ToSpMatrix[_SCT], format: _FmtDOK
) -> dok_matrix[_SCT]: ...
@overload  # A: spmatrix or 2d array-like, B: spmatrix or 2d array-like, format: "lil"
def kron(
    A: _ToSpMatrix[_SCT], B: _ToSpMatrix[_SCT], format: _FmtLIL
) -> lil_matrix[_SCT]: ...

#
@overload  # A: sparray, B: 2D sparse, format: "bsr" | None
def kron(
    A: sparray[_SCT, tuple[int, int]],
    B: _ToSparse2D[_SCT],
    format: _FmtBSR | None = None,
) -> bsr_array[_SCT]: ...
@overload  # A: sparray, B: sparse, format: "coo"
def kron(
    A: sparray[_SCT, tuple[int, int]], B: _ToSparse2D[_SCT], format: _FmtCOO
) -> _COOArray2D[_SCT]: ...
@overload  # A: sparray, B: sparse, format: "csc"
def kron(
    A: sparray[_SCT, tuple[int, int]], B: _ToSparse2D[_SCT], format: _FmtCSC
) -> csc_array[_SCT]: ...
@overload  # A: sparray, B: sparse, format: "csr"
def kron(
    A: sparray[_SCT, tuple[int, int]], B: _ToSparse2D[_SCT], format: _FmtCSR
) -> _CSRArray2D[_SCT]: ...
@overload  # A: sparray, B: sparse, format: "dia"
def kron(
    A: sparray[_SCT, tuple[int, int]], B: _ToSparse2D[_SCT], format: _FmtDIA
) -> dia_array[_SCT]: ...
@overload  # A: sparray, B: sparse, format: "dok"
def kron(
    A: sparray[_SCT, tuple[int, int]], B: _ToSparse2D[_SCT], format: _FmtDOK
) -> _DOKArray2D[_SCT]: ...
@overload  # A: sparray, B: sparse, format: "lil"
def kron(
    A: sparray[_SCT, tuple[int, int]], B: _ToSparse2D[_SCT], format: _FmtLIL
) -> lil_array[_SCT]: ...
...
def kron(
    A: _ToSparse2D[_SCT],
    B: sparray[_SCT, tuple[int, int]],
    format: _FmtBSR | None = None,
) -> bsr_array[_SCT]: ...
@overload  # A: sparray, B: sparse, format: "coo"
def kron(
    A: _ToSparse2D[_SCT], B: sparray[_SCT, tuple[int, int]], format: _FmtCOO
) -> _COOArray2D[_SCT]: ...
@overload  # A: sparray, B: sparse, format: "csc"
def kron(
    A: _ToSparse2D[_SCT], B: sparray[_SCT, tuple[int, int]], format: _FmtCSC
) -> csc_array[_SCT]: ...
@overload  # A: sparray, B: sparse, format: "csr"
def kron(
    A: _ToSparse2D[_SCT], B: sparray[_SCT, tuple[int, int]], format: _FmtCSR
) -> _CSRArray2D[_SCT]: ...
@overload  # A: sparray, B: sparse, format: "dia"
def kron(
    A: _ToSparse2D[_SCT], B: sparray[_SCT, tuple[int, int]], format: _FmtDIA
) -> dia_array[_SCT]: ...
@overload  # A: sparray, B: sparse, format: "dok"
def kron(
    A: _ToSparse2D[_SCT], B: sparray[_SCT, tuple[int, int]], format: _FmtDOK
) -> _DOKArray2D[_SCT]: ...
@overload  # A: sparray, B: sparse, format: "lil"
def kron(
    A: _ToSparse2D[_SCT], B: sparray[_SCT, tuple[int, int]], format: _FmtLIL
) -> lil_array[_SCT]: ...
@overload  # A: unknown array-like, B: unknown array-like  (catch-all)
def kron(
    A: onp.ToComplex2D, B: onp.ToComplex2D, format: _Format | None = None
) -> Incomplete: ...
...
def kronsum(
    A: _ToSpMatrix[_SCT], B: _ToSpMatrix[_SCT], format: _FmtCSR | None = None
) -> csr_matrix[_SCT]: ...
@overload  # A: spmatrix or 2d array-like, B: spmatrix or 2d array-like, format: "bsr"
def kronsum(
    A: _ToSpMatrix[_SCT], B: _ToSpMatrix[_SCT], format: _FmtBSR
) -> bsr_matrix[_SCT]: ...
@overload  # A: spmatrix or 2d array-like, B: spmatrix or 2d array-like, format: "coo"
def kronsum(
    A: _ToSpMatrix[_SCT], B: _ToSpMatrix[_SCT], format: _FmtCOO
...
def kronsum(
    A: sparray[_SCT, tuple[int, int]],
    B: _ToSparse2D[_SCT],
    format: _FmtCSR | None = None,
) -> _CSRArray2D[_SCT]: ...
@overload  # A: sparray, B: sparse, format: "bsr"
def kronsum(
    A: sparray[_SCT, tuple[int, int]], B: _ToSparse2D[_SCT], format: _FmtBSR
) -> bsr_array[_SCT]: ...
@overload  # A: sparray, B: sparse, format: "coo"
def kronsum(
    A: sparray[_SCT, tuple[int, int]], B: _ToSparse2D[_SCT], format: _FmtCOO
...
def kronsum(
    A: _ToSparse2D[_SCT], B: sparray[_SCT, tuple[int, int]], format: _FmtBSR
) -> bsr_array[_SCT]: ...
...
def hstack(
    blocks: Seq[_CanStack[_T]], format: None = None, dtype: None = None
) -> _T: ...
@overload  # sparray, format: "bsr", dtype: <default>
def hstack(
    blocks: Seq[_SpArray2D[_SCT]], format: _FmtBSR, dtype: None = None
) -> bsr_array[_SCT]: ...
@overload  # sparray, format: "coo", dtype: <default>
def hstack(
    blocks: Seq[_SpArray2D[_SCT]], format: _FmtCOO, dtype: None = None
) -> _COOArray2D[_SCT]: ...
@overload  # sparray, format: "csc", dtype: <default>
def hstack(
    blocks: Seq[_SpArray2D[_SCT]], format: _FmtCSC, dtype: None = None
) -> csc_array[_SCT]: ...
@overload  # sparray, format: "csr", dtype: <default>
def hstack(
    blocks: Seq[_SpArray2D[_SCT]], format: _FmtCSR, dtype: None = None
) -> _CSRArray2D[_SCT]: ...
@overload  # sparray, format: "dia", dtype: <default>
def hstack(
    blocks: Seq[_SpArray2D[_SCT]], format: _FmtDIA, dtype: None = None
) -> dia_array[_SCT]: ...
@overload  # sparray, format: "dok", dtype: <default>
def hstack(
    blocks: Seq[_SpArray2D[_SCT]], format: _FmtDOK, dtype: None = None
) -> _DOKArray2D[_SCT]: ...
@overload  # sparray, format: "lil", dtype: <default>
def hstack(
    blocks: Seq[_SpArray2D[_SCT]], format: _FmtLIL, dtype: None = None
) -> lil_array[_SCT]: ...

#
@overload  # sparray, format: <default>, dtype: bool-like
def hstack(
    blocks: Seq[_CanStackAs[np.bool_, _T]],
    format: None = None,
    *,
    dtype: onp.AnyBoolDType,
) -> _T: ...
...
def hstack(
    blocks: Seq[sparray], format: _FmtBSR, dtype: onp.AnyBoolDType
) -> bsr_array[np.bool_]: ...
@overload  # sparray, format: "coo", dtype: bool-like
def hstack(
    blocks: Seq[sparray], format: _FmtCOO, dtype: onp.AnyBoolDType
) -> _COOArray2D[np.bool_]: ...
@overload  # sparray, format: "csc", dtype: bool-like
def hstack(
    blocks: Seq[sparray], format: _FmtCSC, dtype: onp.AnyBoolDType
) -> csc_array[np.bool_]: ...
@overload  # sparray, format: "csr", dtype: bool-like
def hstack(
    blocks: Seq[sparray], format: _FmtCSR, dtype: onp.AnyBoolDType
) -> _CSRArray2D[np.bool_]: ...
@overload  # sparray, format: "dia", dtype: bool-like
def hstack(
    blocks: Seq[sparray], format: _FmtDIA, dtype: onp.AnyBoolDType
) -> dia_array[np.bool_]: ...
@overload  # sparray, format: "dok", dtype: bool-like
def hstack(
    blocks: Seq[sparray], format: _FmtDOK, dtype: onp.AnyBoolDType
) -> _DOKArray2D[np.bool_]: ...
@overload  # sparray, format: "lil", dtype: bool-like
def hstack(
    blocks: Seq[sparray], format: _FmtLIL, dtype: onp.AnyBoolDType
) -> lil_array[np.bool_]: ...

#
@overload  # sparray, format: <default>, dtype: int-like
def hstack(
    blocks: Seq[_CanStackAs[np.int_, _T]],
    format: None = None,
    *,
    dtype: onp.AnyIntDType,
) -> _T: ...
...
def hstack(
    blocks: Seq[sparray], format: _FmtBSR, dtype: onp.AnyIntDType
) -> bsr_array[np.int_]: ...
@overload  # sparray, format: "coo", dtype: int-like
def hstack(
    blocks: Seq[sparray], format: _FmtCOO, dtype: onp.AnyIntDType
) -> _COOArray2D[np.int_]: ...
@overload  # sparray, format: "csc", dtype: int-like
def hstack(
    blocks: Seq[sparray], format: _FmtCSC, dtype: onp.AnyIntDType
) -> csc_array[np.int_]: ...
@overload  # sparray, format: "csr", dtype: int-like
def hstack(
    blocks: Seq[sparray], format: _FmtCSR, dtype: onp.AnyIntDType
) -> _CSRArray2D[np.int_]: ...
@overload  # sparray, format: "dia", dtype: int-like
def hstack(
    blocks: Seq[sparray], format: _FmtDIA, dtype: onp.AnyIntDType
) -> dia_array[np.int_]: ...
@overload  # sparray, format: "dok", dtype: int-like
def hstack(
    blocks: Seq[sparray], format: _FmtDOK, dtype: onp.AnyIntDType
) -> _DOKArray2D[np.int_]: ...
@overload  # sparray, format: "lil", dtype: int-like
def hstack(
    blocks: Seq[sparray], format: _FmtLIL, dtype: onp.AnyIntDType
) -> lil_array[np.int_]: ...

#
@overload  # sparray, format: <default>, dtype: float64-like
def hstack(
    blocks: Seq[_CanStackAs[np.float64, _T]],
    format: None = None,
    *,
    dtype: onp.AnyFloat64DType,
) -> _T: ...
...
def hstack(
    blocks: Seq[sparray], format: _FmtBSR, dtype: onp.AnyFloat64DType
) -> bsr_array[np.float64]: ...
@overload  # sparray, format: "coo", dtype: float64-like
def hstack(
    blocks: Seq[sparray], format: _FmtCOO, dtype: onp.AnyFloat64DType
) -> _COOArray2D[np.float64]: ...
@overload  # sparray, format: "csc", dtype: float64-like
def hstack(
    blocks: Seq[sparray], format: _FmtCSC, dtype: onp.AnyFloat64DType
) -> csc_array[np.float64]: ...
@overload  # sparray, format: "csr", dtype: float64-like
def hstack(
    blocks: Seq[sparray], format: _FmtCSR, dtype: onp.AnyFloat64DType
) -> _CSRArray2D[np.float64]: ...
@overload  # sparray, format: "dia", dtype: float64-like
def hstack(
    blocks: Seq[sparray], format: _FmtDIA, dtype: onp.AnyFloat64DType
) -> dia_array[np.float64]: ...
@overload  # sparray, format: "dok", dtype: float64-like
def hstack(
    blocks: Seq[sparray], format: _FmtDOK, dtype: onp.AnyFloat64DType
) -> _DOKArray2D[np.float64]: ...
@overload  # sparray, format: "lil", dtype: float64-like
def hstack(
    blocks: Seq[sparray], format: _FmtLIL, dtype: onp.AnyFloat64DType
) -> lil_array[np.float64]: ...

#
@overload  # sparray, format: <default>, dtype: complex128-like
def hstack(
    blocks: Seq[_CanStackAs[np.complex128, _T]],
    format: None = None,
    *,
    dtype: onp.AnyComplex128DType,
) -> _T: ...
...
def hstack(
    blocks: Seq[sparray], format: _FmtBSR, dtype: onp.AnyComplex128DType
) -> bsr_array[np.complex128]: ...
@overload  # sparray, format: "coo", dtype: complex128-like
def hstack(
    blocks: Seq[sparray], format: _FmtCOO, dtype: onp.AnyComplex128DType
) -> _COOArray2D[np.complex128]: ...
@overload  # sparray, format: "csc", dtype: complex128-like
def hstack(
    blocks: Seq[sparray], format: _FmtCSC, dtype: onp.AnyComplex128DType
) -> csc_array[np.complex128]: ...
@overload  # sparray, format: "csr", dtype: complex128-like
def hstack(
    blocks: Seq[sparray], format: _FmtCSR, dtype: onp.AnyComplex128DType
) -> _CSRArray2D[np.complex128]: ...
@overload  # sparray, format: "dia", dtype: complex128-like
def hstack(
    blocks: Seq[sparray], format: _FmtDIA, dtype: onp.AnyComplex128DType
) -> dia_array[np.complex128]: ...
@overload  # sparray, format: "dok", dtype: complex128-like
def hstack(
    blocks: Seq[sparray], format: _FmtDOK, dtype: onp.AnyComplex128DType
) -> _DOKArray2D[np.complex128]: ...
@overload  # sparray, format: "lil", dtype: complex128-like
def hstack(
    blocks: Seq[sparray], format: _FmtLIL, dtype: onp.AnyComplex128DType
) -> lil_array[np.complex128]: ...

#
@overload  # sparray, format: <default>, dtype: <known>
def hstack(
    blocks: Seq[_CanStackAs[_SCT, _T]], format: None = None, *, dtype: onp.ToDType[_SCT]
) -> _T: ...
@overload  # sparray, format: "bsr", dtype: <known>
def hstack(
    blocks: Seq[sparray], format: _FmtBSR, dtype: onp.ToDType[_SCT]
) -> bsr_array[_SCT]: ...
@overload  # sparray, format: "coo", dtype: <known>
def hstack(
    blocks: Seq[sparray], format: _FmtCOO, dtype: onp.ToDType[_SCT]
) -> _COOArray2D[_SCT]: ...
@overload  # sparray, format: "csc", dtype: <known>
def hstack(
    blocks: Seq[sparray], format: _FmtCSC, dtype: onp.ToDType[_SCT]
) -> csc_array[_SCT]: ...
@overload  # sparray, format: "csr", dtype: <known>
def hstack(
    blocks: Seq[sparray], format: _FmtCSR, dtype: onp.ToDType[_SCT]
) -> _CSRArray2D[_SCT]: ...
@overload  # sparray, format: "dia", dtype: <known>
def hstack(
    blocks: Seq[sparray], format: _FmtDIA, dtype: onp.ToDType[_SCT]
) -> dia_array[_SCT]: ...
@overload  # sparray, format: "dok", dtype: <known>
def hstack(
    blocks: Seq[sparray], format: _FmtDOK, dtype: onp.ToDType[_SCT]
) -> _DOKArray2D[_SCT]: ...
@overload  # sparray, format: "lil", dtype: <known>
def hstack(
    blocks: Seq[sparray], format: _FmtLIL, dtype: onp.ToDType[_SCT]
) -> lil_array[_SCT]: ...

#
@overload  # sparray, format: <default>, dtype: <unknown>
def hstack(
    blocks: Seq[_CanStackAs[Any, _T]], format: None = None, *, dtype: _ToDType
) -> _T: ...
...
@overload
def hstack(
    blocks: Seq[_spbase], format: _Format, dtype: _ToDType | None = None
) -> Incomplete: ...
...
def block_array(
    blocks: _ToBlocks[_CanStack[_T]], *, format: None = None, dtype: None = None
) -> _T: ...
@overload  # blocks: <array, known>, format: "bsr", dtype: <default>
def block_array(
    blocks: _ToBlocksSpArray[_SCT], *, format: _FmtBSR, dtype: None = None
) -> bsr_array[_SCT]: ...
@overload  # blocks: <array, known>, format: "coo", dtype: <default>
def block_array(
    blocks: _ToBlocksSpArray[_SCT], *, format: _FmtCOO, dtype: None = None
) -> _COOArray2D[_SCT]: ...
@overload  # blocks: <array, known>, format: "csc", dtype: <default>
def block_array(
    blocks: _ToBlocksSpArray[_SCT], *, format: _FmtCSC, dtype: None = None
) -> csc_array[_SCT]: ...
@overload  # blocks: <array, known>, format: "csr", dtype: <default>
def block_array(
    blocks: _ToBlocksSpArray[_SCT], *, format: _FmtCSR, dtype: None = None
) -> _CSRArray2D[_SCT]: ...
@overload  # blocks: <array, known>, format: "dia", dtype: <default>
def block_array(
    blocks: _ToBlocksSpArray[_SCT], *, format: _FmtDIA, dtype: None = None
) -> dia_array[_SCT]: ...
@overload  # blocks: <array, known>, format: "dok", dtype: <default>
def block_array(
    blocks: _ToBlocksSpArray[_SCT], *, format: _FmtDOK, dtype: None = None
) -> _DOKArray2D[_SCT]: ...
@overload  # blocks: <array, known>, format: "lil", dtype: <default>
def block_array(
    blocks: _ToBlocksSpArray[_SCT], *, format: _FmtLIL, dtype: None = None
) -> lil_array[_SCT]: ...

#
@overload  # blocks: <known, bool_>, format: <default>, dtype: bool-like
def block_array(
    blocks: _ToBlocksCanStackAs[np.bool_, _T],
    *,
    format: None = None,
    dtype: onp.AnyBoolDType,
) -> _T: ...
...
def block_array(
    blocks: _ToBlocksUnkown, *, format: _FmtBSR, dtype: onp.AnyBoolDType
) -> bsr_array[np.bool_]: ...
@overload  # blocks: <unknown, unknown>, format: "coo", dtype: bool-like
def block_array(
    blocks: _ToBlocksUnkown, *, format: _FmtCOO, dtype: onp.AnyBoolDType
) -> _COOArray2D[np.bool_]: ...
@overload  # blocks: <unknown, unknown>, format: "csc", dtype: bool-like
def block_array(
    blocks: _ToBlocksUnkown, *, format: _FmtCSC, dtype: onp.AnyBoolDType
) -> csc_array[np.bool_]: ...
@overload  # blocks: <unknown, unknown>, format: "csr", dtype: bool-like
def block_array(
    blocks: _ToBlocksUnkown, *, format: _FmtCSR, dtype: onp.AnyBoolDType
) -> _CSRArray2D[np.bool_]: ...
@overload  # blocks: <unknown, unknown>, format: "dia", dtype: bool-like
def block_array(
    blocks: _ToBlocksUnkown, *, format: _FmtDIA, dtype: onp.AnyBoolDType
) -> dia_array[np.bool_]: ...
@overload  # blocks: <unknown, unknown>, format: "dok", dtype: bool-like
def block_array(
    blocks: _ToBlocksUnkown, *, format: _FmtDOK, dtype: onp.AnyBoolDType
) -> _DOKArray2D[np.bool_]: ...
@overload  # blocks: <unknown, unknown>, format: "lil", dtype: bool-like
def block_array(
    blocks: _ToBlocksUnkown, *, format: _FmtLIL, dtype: onp.AnyBoolDType
) -> lil_array[np.bool_]: ...

#
@overload  # blocks: <known, int_>, format: <default>, dtype: int-like
def block_array(
    blocks: _ToBlocksCanStackAs[np.int64, _T],
    *,
    format: None = None,
    dtype: onp.AnyIntDType,
) -> _T: ...
...
def block_array(
    blocks: _ToBlocksUnkown, *, format: _FmtBSR, dtype: onp.AnyIntDType
) -> bsr_array[np.int_]: ...
@overload  # blocks: <unknown, unknown>, format: "coo", dtype: int-like
def block_array(
    blocks: _ToBlocksUnkown, *, format: _FmtCOO, dtype: onp.AnyIntDType
) -> _COOArray2D[np.int_]: ...
@overload  # blocks: <unknown, unknown>, format: "csc", dtype: int-like
def block_array(
    blocks: _ToBlocksUnkown, *, format: _FmtCSC, dtype: onp.AnyIntDType
) -> csc_array[np.int_]: ...
@overload  # blocks: <unknown, unknown>, format: "csr", dtype: int-like
def block_array(
    blocks: _ToBlocksUnkown, *, format: _FmtCSR, dtype: onp.AnyIntDType
) -> _CSRArray2D[np.int_]: ...
@overload  # blocks: <unknown, unknown>, format: "dia", dtype: int-like
def block_array(
    blocks: _ToBlocksUnkown, *, format: _FmtDIA, dtype: onp.AnyIntDType
) -> dia_array[np.int_]: ...
@overload  # blocks: <unknown, unknown>, format: "dok", dtype: int-like
def block_array(
    blocks: _ToBlocksUnkown, *, format: _FmtDOK, dtype: onp.AnyIntDType
) -> _DOKArray2D[np.int_]: ...
@overload  # blocks: <unknown, unknown>, format: "lil", dtype: int-like
def block_array(
    blocks: _ToBlocksUnkown, *, format: _FmtLIL, dtype: onp.AnyIntDType
) -> lil_array[np.int_]: ...

#
@overload  # blocks: <known, float64>, format: <default>, dtype: float64-like
def block_array(
    blocks: _ToBlocksCanStackAs[np.float64, _T],
    *,
    format: None = None,
    dtype: onp.AnyFloat64DType,
) -> _T: ...
...
def block_array(
    blocks: _ToBlocksUnkown, *, format: _FmtBSR, dtype: onp.AnyFloat64DType
) -> bsr_array[np.float64]: ...
@overload  # blocks: <unknown, unknown>, format: "coo", dtype: float64-like
def block_array(
    blocks: _ToBlocksUnkown, *, format: _FmtCOO, dtype: onp.AnyFloat64DType
) -> _COOArray2D[np.float64]: ...
@overload  # blocks: <unknown, unknown>, format: "csc", dtype: float64-like
def block_array(
    blocks: _ToBlocksUnkown, *, format: _FmtCSC, dtype: onp.AnyFloat64DType
) -> csc_array[np.float64]: ...
@overload  # blocks: <unknown, unknown>, format: "csr", dtype: float64-like
def block_array(
    blocks: _ToBlocksUnkown, *, format: _FmtCSR, dtype: onp.AnyFloat64DType
) -> _CSRArray2D[np.float64]: ...
@overload  # blocks: <unknown, unknown>, format: "dia", dtype: float64-like
def block_array(
    blocks: _ToBlocksUnkown, *, format: _FmtDIA, dtype: onp.AnyFloat64DType
) -> dia_array[np.float64]: ...
@overload  # blocks: <unknown, unknown>, format: "dok", dtype: float64-like
def block_array(
    blocks: _ToBlocksUnkown, *, format: _FmtDOK, dtype: onp.AnyFloat64DType
) -> _DOKArray2D[np.float64]: ...
@overload  # blocks: <unknown, unknown>, format: "lil", dtype: float64-like
def block_array(
    blocks: _ToBlocksUnkown, *, format: _FmtLIL, dtype: onp.AnyFloat64DType
) -> lil_array[np.float64]: ...

#
@overload  # blocks: <known, complex128>, format: <default>, dtype: complex128-like
def block_array(
    blocks: _ToBlocksCanStackAs[np.complex128, _T],
    *,
    format: None = None,
    dtype: onp.AnyComplex128DType,
) -> _T: ...
...
def block_array(
    blocks: _ToBlocksUnkown, *, format: _FmtBSR, dtype: onp.AnyComplex128DType
) -> bsr_array[np.complex128]: ...
@overload  # blocks: <unknown, unknown>, format: "coo", dtype: complex128-like
def block_array(
    blocks: _ToBlocksUnkown, *, format: _FmtCOO, dtype: onp.AnyComplex128DType
) -> _COOArray2D[np.complex128]: ...
@overload  # blocks: <unknown, unknown>, format: "csc", dtype: complex128-like
def block_array(
    blocks: _ToBlocksUnkown, *, format: _FmtCSC, dtype: onp.AnyComplex128DType
) -> csc_array[np.complex128]: ...
@overload  # blocks: <unknown, unknown>, format: "csr", dtype: complex128-like
def block_array(
    blocks: _ToBlocksUnkown, *, format: _FmtCSR, dtype: onp.AnyComplex128DType
) -> _CSRArray2D[np.complex128]: ...
@overload  # blocks: <unknown, unknown>, format: "dia", dtype: complex128-like
def block_array(
    blocks: _ToBlocksUnkown, *, format: _FmtDIA, dtype: onp.AnyComplex128DType
) -> dia_array[np.complex128]: ...
@overload  # blocks: <unknown, unknown>, format: "dok", dtype: complex128-like
def block_array(
    blocks: _ToBlocksUnkown, *, format: _FmtDOK, dtype: onp.AnyComplex128DType
) -> _DOKArray2D[np.complex128]: ...
@overload  # blocks: <unknown, unknown>, format: "lil", dtype: complex128-like
def block_array(
    blocks: _ToBlocksUnkown, *, format: _FmtLIL, dtype: onp.AnyComplex128DType
) -> lil_array[np.complex128]: ...

#
@overload  # blocks: <known, known>, format: <default>, dtype: <known>
def block_array(
    blocks: _ToBlocksCanStackAs[_SCT, _T],
    *,
    format: None = None,
    dtype: onp.ToDType[_SCT],
) -> _T: ...
...
def block_array(
    blocks: _ToBlocksUnkown, *, format: _FmtBSR, dtype: onp.ToDType[_SCT]
) -> bsr_array[_SCT]: ...
@overload  # blocks: <unknown, unknown>, format: "coo", dtype: <known>
def block_array(
    blocks: _ToBlocksUnkown, *, format: _FmtCOO, dtype: onp.ToDType[_SCT]
) -> _COOArray2D[_SCT]: ...
@overload  # blocks: <unknown, unknown>, format: "csc", dtype: <known>
def block_array(
    blocks: _ToBlocksUnkown, *, format: _FmtCSC, dtype: onp.ToDType[_SCT]
) -> csc_array[_SCT]: ...
@overload  # blocks: <unknown, unknown>, format: "csr", dtype: <known>
def block_array(
    blocks: _ToBlocksUnkown, *, format: _FmtCSR, dtype: onp.ToDType[_SCT]
) -> _CSRArray2D[_SCT]: ...
@overload  # blocks: <unknown, unknown>, format: "dia", dtype: <known>
def block_array(
    blocks: _ToBlocksUnkown, *, format: _FmtDIA, dtype: onp.ToDType[_SCT]
) -> dia_array[_SCT]: ...
@overload  # blocks: <unknown>, format: "dok", dtype: <known>
def block_array(
    blocks: _ToBlocksUnkown, *, format: _FmtDOK, dtype: onp.ToDType[_SCT]
) -> _DOKArray2D[_SCT]: ...
@overload  # blocks: <unknown, unknown>, format: "lil", dtype: <known>
def block_array(
    blocks: _ToBlocksUnkown, *, format: _FmtLIL, dtype: onp.ToDType[_SCT]
) -> lil_array[_SCT]: ...

#
@overload  # blocks: <known, unknown>, format: <default>, dtype: <unknown>
def block_array(
    blocks: _ToBlocksCanStackAs[Any, _T],
    *,
    format: None = None,
...
def block_array(
    blocks: _ToBlocksUnkown, *, format: _FmtBSR, dtype: _ToDType | None = None
) -> bsr_array: ...
@overload  # blocks: <unknown, unknown>, format: "coo", dtype: <unknown>
def block_array(
    blocks: _ToBlocksUnkown, *, format: _FmtCOO, dtype: _ToDType | None = None
) -> _COOArray2D: ...
@overload  # blocks: <unknown, unknown>, format: "csc", dtype: <unknown>
def block_array(
    blocks: _ToBlocksUnkown, *, format: _FmtCSC, dtype: _ToDType | None = None
) -> csc_array: ...
@overload  # blocks: <unknown, unknown>, format: "csr", dtype: <unknown>
def block_array(
    blocks: _ToBlocksUnkown, *, format: _FmtCSR, dtype: _ToDType | None = None
) -> _CSRArray2D: ...
@overload  # blocks: <unknown, unknown>, format: "dia", dtype: <unknown>
def block_array(
    blocks: _ToBlocksUnkown, *, format: _FmtDIA, dtype: _ToDType | None = None
) -> dia_array: ...
@overload  # blocks: <unknown, unknown>, format: "dok", dtype: <unknown>
def block_array(
    blocks: _ToBlocksUnkown, *, format: _FmtDOK, dtype: _ToDType | None = None
) -> _DOKArray2D: ...
@overload  # blocks: <unknown, unknown>, format: "lil", dtype: <unknown>
def block_array(
    blocks: _ToBlocksUnkown, *, format: _FmtLIL, dtype: _ToDType | None = None
) -> lil_array: ...
...
def bmat(
    blocks: _ToBlocks[spmatrix[_SCT]], format: _Format, dtype: None = None
) -> spmatrix[_SCT]: ...
...
def bmat(
    blocks: _ToBlocks[spmatrix[_SCT]], format: _Format, dtype: onp.ToDType[_SCT]
) -> spmatrix[_SCT]: ...
@overload  # blocks: <unknown, unknown>, format: <otherwise>, dtype: <known>
def bmat(
    blocks: _ToBlocksUnkown, format: _Format, dtype: onp.ToDType[_SCT]
) -> spmatrix[_SCT] | _SpArray2D[_SCT]: ...

#
@overload  # blocks: <known, unknown>, format: <default>, dtype: <unknown>
def bmat(
    blocks: _ToBlocksCanStackAs[Any, _T], format: None = None, *, dtype: _ToDType
) -> _T: ...
@overload  # blocks: <matrix, unknown>, format: <otherwise>, dtype: <unknown>
def bmat(
    blocks: _ToBlocks[spmatrix[_Numeric]], format: _Format, *, dtype: _ToDType
) -> spmatrix: ...
@overload  # blocks: <unknown, unknown>, format: <otherwise>, dtype: <unknown>
def bmat(
    blocks: _ToBlocksUnkown, format: _Format, *, dtype: _ToDType
) -> spmatrix | _SpArray2D: ...

###
@overload  # mats: <array, known>, format: <default>, dtype: None
def block_diag(
    mats: Iterable[sparray[_SCT]], format: _FmtCOO | None = None, dtype: None = None
) -> _COOArray2D[_SCT]: ...
@overload  # mats: <array, known>, format: "bsr", dtype: None
def block_diag(
    mats: Iterable[sparray[_SCT]], format: _FmtBSR, dtype: None = None
) -> bsr_array[_SCT]: ...
@overload  # mats: <array, known>, format: "csc", dtype: None
def block_diag(
    mats: Iterable[sparray[_SCT]], format: _FmtCSC, dtype: None = None
) -> csc_array[_SCT]: ...
@overload  # mats: <array, known>, format: "csr", dtype: None
def block_diag(
    mats: Iterable[sparray[_SCT]], format: _FmtCSR, dtype: None = None
) -> _CSRArray2D[_SCT]: ...
@overload  # mats: <array, known>, format: "dia", dtype: None
def block_diag(
    mats: Iterable[sparray[_SCT]], format: _FmtDIA, dtype: None = None
) -> dia_array[_SCT]: ...
@overload  # mats: <array, known>, format: "dok", dtype: None
def block_diag(
    mats: Iterable[sparray[_SCT]], format: _FmtDOK, dtype: None = None
) -> _DOKArray2D[_SCT]: ...
@overload  # mats: <array, known>, format: "lil", dtype: None
def block_diag(
    mats: Iterable[sparray[_SCT]], format: _FmtLIL, dtype: None = None
) -> lil_array[_SCT]: ...

#
@overload  # mats: <array, unknown>, format: <default>, dtype: bool-like
def block_diag(
    mats: Iterable[sparray], format: _FmtCOO | None = None, *, dtype: onp.AnyBoolDType
) -> _COOArray2D[np.bool_]: ...
@overload  # mats: <array, unknown>, format: "bsr", dtype: bool-like
def block_diag(
    mats: Iterable[sparray], format: _FmtBSR, dtype: onp.AnyBoolDType
) -> bsr_array[np.bool_]: ...
@overload  # mats: <array, unknown>, format: "csc", dtype: bool-like
def block_diag(
    mats: Iterable[sparray], format: _FmtCSC, dtype: onp.AnyBoolDType
) -> csc_array[np.bool_]: ...
@overload  # mats: <array, unknown>, format: "csr", dtype: bool-like
def block_diag(
    mats: Iterable[sparray], format: _FmtCSR, dtype: onp.AnyBoolDType
) -> _CSRArray2D[np.bool_]: ...
@overload  # mats: <array, unknown>, format: "dia", dtype: bool-like
def block_diag(
    mats: Iterable[sparray], format: _FmtDIA, dtype: onp.AnyBoolDType
) -> dia_array[np.bool_]: ...
@overload  # mats: <array, unknown>, format: "dok", dtype: bool-like
def block_diag(
    mats: Iterable[sparray], format: _FmtDOK, dtype: onp.AnyBoolDType
) -> _DOKArray2D[np.bool_]: ...
@overload  # mats: <array, unknown>, format: "lil", dtype: bool-like
def block_diag(
    mats: Iterable[sparray], format: _FmtLIL, dtype: onp.AnyBoolDType
) -> lil_array[np.bool_]: ...

#
@overload  # mats: <array, unknown>, format: <default>, dtype: int-like
def block_diag(
    mats: Iterable[sparray], format: _FmtCOO | None = None, *, dtype: onp.AnyIntDType
) -> _COOArray2D[np.int_]: ...
@overload  # mats: <array, unknown>, format: "bsr", dtype: int-like
def block_diag(
    mats: Iterable[sparray], format: _FmtBSR, dtype: onp.AnyIntDType
) -> bsr_array[np.int_]: ...
@overload  # mats: <array, unknown>, format: "csc", dtype: int-like
def block_diag(
    mats: Iterable[sparray], format: _FmtCSC, dtype: onp.AnyIntDType
) -> csc_array[np.int_]: ...
@overload  # mats: <array, unknown>, format: "csr", dtype: int-like
def block_diag(
    mats: Iterable[sparray], format: _FmtCSR, dtype: onp.AnyIntDType
) -> _CSRArray2D[np.int_]: ...
@overload  # mats: <array, unknown>, format: "dia", dtype: int-like
def block_diag(
    mats: Iterable[sparray], format: _FmtDIA, dtype: onp.AnyIntDType
) -> dia_array[np.int_]: ...
@overload  # mats: <array, unknown>, format: "dok", dtype: int-like
def block_diag(
    mats: Iterable[sparray], format: _FmtDOK, dtype: onp.AnyIntDType
) -> _DOKArray2D[np.int_]: ...
@overload  # mats: <array, unknown>, format: "lil", dtype: int-like
def block_diag(
    mats: Iterable[sparray], format: _FmtLIL, dtype: onp.AnyIntDType
) -> lil_array[np.int_]: ...
...
def block_diag(
    mats: Iterable[sparray], format: _FmtBSR, dtype: onp.AnyFloat64DType
) -> bsr_array[np.float64]: ...
@overload  # mats: <array, unknown>, format: "csc", dtype: float64-like
def block_diag(
    mats: Iterable[sparray], format: _FmtCSC, dtype: onp.AnyFloat64DType
) -> csc_array[np.float64]: ...
@overload  # mats: <array, unknown>, format: "csr", dtype: float64-like
def block_diag(
    mats: Iterable[sparray], format: _FmtCSR, dtype: onp.AnyFloat64DType
) -> _CSRArray2D[np.float64]: ...
@overload  # mats: <array, unknown>, format: "dia", dtype: float64-like
def block_diag(
    mats: Iterable[sparray], format: _FmtDIA, dtype: onp.AnyFloat64DType
) -> dia_array[np.float64]: ...
@overload  # mats: <array, unknown>, format: "dok", dtype: float64-like
def block_diag(
    mats: Iterable[sparray], format: _FmtDOK, dtype: onp.AnyFloat64DType
) -> _DOKArray2D[np.float64]: ...
@overload  # mats: <array, unknown>, format: "lil", dtype: float64-like
def block_diag(
    mats: Iterable[sparray], format: _FmtLIL, dtype: onp.AnyFloat64DType
) -> lil_array[np.float64]: ...
...
def block_diag(
    mats: Iterable[sparray], format: _FmtBSR, dtype: onp.AnyComplex128DType
) -> bsr_array[np.complex128]: ...
@overload  # mats: <array, unknown>, format: "csc", dtype: complex128-like
def block_diag(
    mats: Iterable[sparray], format: _FmtCSC, dtype: onp.AnyComplex128DType
) -> csc_array[np.complex128]: ...
@overload  # mats: <array, unknown>, format: "csr", dtype: complex128-like
def block_diag(
    mats: Iterable[sparray], format: _FmtCSR, dtype: onp.AnyComplex128DType
) -> _CSRArray2D[np.complex128]: ...
@overload  # mats: <array, unknown>, format: "dia", dtype: complex128-like
def block_diag(
    mats: Iterable[sparray], format: _FmtDIA, dtype: onp.AnyComplex128DType
) -> dia_array[np.complex128]: ...
@overload  # mats: <array, unknown>, format: "dok", dtype: complex128-like
def block_diag(
    mats: Iterable[sparray], format: _FmtDOK, dtype: onp.AnyComplex128DType
) -> _DOKArray2D[np.complex128]: ...
@overload  # mats: <array, unknown>, format: "lil", dtype: complex128-like
def block_diag(
    mats: Iterable[sparray], format: _FmtLIL, dtype: onp.AnyComplex128DType
) -> lil_array[np.complex128]: ...

#
@overload  # mats: <array, unknown>, format: <default>, dtype: <known>
def block_diag(
    mats: Iterable[sparray], format: _FmtCOO | None = None, *, dtype: onp.ToDType[_SCT]
) -> _COOArray2D[_SCT]: ...
@overload  # mats: <array, unknown>, format: "bsr", dtype: <known>
def block_diag(
    mats: Iterable[sparray], format: _FmtBSR, dtype: onp.ToDType[_SCT]
) -> bsr_array[_SCT]: ...
@overload  # mats: <array, unknown>, format: "csc", dtype: <known>
def block_diag(
    mats: Iterable[sparray], format: _FmtCSC, dtype: onp.ToDType[_SCT]
) -> csc_array[_SCT]: ...
@overload  # mats: <array, unknown>, format: "csr", dtype: <known>
def block_diag(
    mats: Iterable[sparray], format: _FmtCSR, dtype: onp.ToDType[_SCT]
) -> _CSRArray2D[_SCT]: ...
@overload  # mats: <array, unknown>, format: "dia", dtype: <known>
def block_diag(
    mats: Iterable[sparray], format: _FmtDIA, dtype: onp.ToDType[_SCT]
) -> dia_array[_SCT]: ...
@overload  # mats: <array, unknown>, format: "dok", dtype: <known>
def block_diag(
    mats: Iterable[sparray], format: _FmtDOK, dtype: onp.ToDType[_SCT]
) -> _DOKArray2D[_SCT]: ...
@overload  # mats: <array, unknown>, format: "lil", dtype: <known>
def block_diag(
    mats: Iterable[sparray], format: _FmtLIL, dtype: onp.ToDType[_SCT]
) -> lil_array[_SCT]: ...
...
def block_diag(
    mats: _ToMatsDiag[_SCT], format: _FmtBSR, dtype: None = None
) -> bsr_array[_SCT] | bsr_matrix[_SCT]: ...
@overload  # mats: <unknown, known>, format: "csc", dtype: None
def block_diag(
    mats: _ToMatsDiag[_SCT], format: _FmtCSC, dtype: None = None
) -> csc_array[_SCT] | csc_matrix[_SCT]: ...
@overload  # mats: <unknown, known>, format: "csr", dtype: None
def block_diag(
    mats: _ToMatsDiag[_SCT], format: _FmtCSR, dtype: None = None
) -> _CSRArray2D[_SCT] | csr_matrix[_SCT]: ...
@overload  # mats: <unknown, known>, format: "dia", dtype: None
def block_diag(
    mats: _ToMatsDiag[_SCT], format: _FmtDIA, dtype: None = None
) -> dia_array[_SCT] | dia_matrix[_SCT]: ...
@overload  # mats: <unknown, known>, format: "dok", dtype: None
def block_diag(
    mats: _ToMatsDiag[_SCT], format: _FmtDOK, dtype: None = None
) -> _DOKArray2D[_SCT] | dok_matrix[_SCT]: ...
@overload  # mats: <unknown, known>, format: "lil", dtype: None
def block_diag(
    mats: _ToMatsDiag[_SCT], format: _FmtLIL, dtype: None = None
) -> lil_array[_SCT] | lil_matrix[_SCT]: ...
