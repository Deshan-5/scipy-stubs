...
def fftfreq(
    n: int, d: float = 1.0, *, xp: ModuleType, device: object | None = None
) -> Incomplete: ...
...
@overload
def fftshift(
    x: onp.ToIntND | onp.ToJustFloat64_ND, axes: AnyShape | None = None
) -> onp.ArrayND[np.float64]: ...
@overload
def fftshift(
    x: onp.ToJustComplex128_ND, axes: AnyShape | None = None
) -> onp.ArrayND[np.complex128]: ...
@overload
def fftshift(
    x: onp.ToArrayND[_InexactT, _InexactT], axes: AnyShape | None = None
) -> onp.ArrayND[_InexactT]: ...
@overload
def fftshift(
    x: onp.ToComplexND, axes: AnyShape | None = None
