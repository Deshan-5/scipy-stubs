...
_ToStrict2ND: TypeAlias = (
    onp.SequenceND[_To1D[_ScalarT]] | onp.CanArrayND[_ScalarT, onp.AtLeast2D]
)
...
@overload
def toeplitz(
    c: onp.ArrayND[_ScalarT, _JustAnyShape],
    r: onp.ToArrayND[_ScalarT, _ScalarT] | None = None,
) -> onp.ArrayND[_ScalarT]: ...
@overload
def toeplitz(c: list[bool], r: onp.ToBoolStrict1D | None = None) -> _Bool2D: ...  # type: ignore[overload-overlap]
@overload
def toeplitz(
    c: list[int], r: onp.ToArrayStrict1D[int, npc.integer] | None = None
) -> _Int2D: ...
@overload
def toeplitz(
    c: list[float], r: onp.ToArrayStrict1D[float, npc.floating64] | None = None
) -> _Float2D: ...
@overload
def toeplitz(
    c: list[complex], r: onp.ToArrayStrict1D[complex, npc.inexact64] | None = None
) -> _Complex2D: ...
@overload
def toeplitz(
    c: onp.ToArrayStrict1D[_ScalarT, _ScalarT],
    r: onp.ToArrayStrict1D[_ScalarT, _ScalarT] | None = None,
...
@overload
def toeplitz(
    c: Sequence[list[int]], r: onp.ToArrayStrict1D[int, npc.integer] | None = None
) -> _Int3D: ...
@overload
def toeplitz(
    c: Sequence[list[float]],
    r: onp.ToArrayStrict1D[float, npc.floating64] | None = None,
) -> _Float3D: ...
@overload
def toeplitz(
    c: Sequence[list[complex]],
    r: onp.ToArrayStrict1D[complex, npc.inexact64] | None = None,
) -> _Complex3D: ...
@overload
def toeplitz(
    c: onp.ToArrayStrict2D[_ScalarT, _ScalarT],
    r: onp.ToArrayStrict2D[_ScalarT, _ScalarT] | None = None,
...
@overload
def toeplitz(
    c: onp.ToJustFloat64_ND, r: onp.ToFloat64_ND | None = None
) -> _FloatND: ...
@overload
def toeplitz(
    c: onp.ToJustComplex128_ND, r: onp.ToComplex128_ND | None = None
) -> _ComplexND: ...
@overload
def toeplitz(
    c: onp.ToArrayND[_ScalarT, _ScalarT],
    r: onp.ToArrayND[_ScalarT, _ScalarT] | None = None,
) -> onp.ArrayND[_ScalarT]: ...
...
def convolution_matrix(
    a: onp.ArrayND[_ScalarT, _JustAnyShape], n: int, mode: _ConvMode = "full"
) -> onp.ArrayND[_ScalarT]: ...
@overload
...
@overload
def convolution_matrix(
    a: list[float], n: int, mode: _ConvMode = "full"
) -> _Float2D: ...
@overload
def convolution_matrix(
    a: list[complex], n: int, mode: _ConvMode = "full"
) -> _Complex2D: ...
@overload
def convolution_matrix(
    a: onp.ToArrayStrict1D[_ScalarT, _ScalarT], n: int, mode: _ConvMode = "full"
) -> onp.Array2D[_ScalarT]: ...
@overload
def convolution_matrix(a: Sequence[list[bool]], n: int, mode: _ConvMode = "full") -> _Bool3D: ...  # type: ignore[overload-overlap]
@overload
def convolution_matrix(
    a: Sequence[list[int]], n: int, mode: _ConvMode = "full"
) -> _Int3D: ...
@overload
def convolution_matrix(
    a: Sequence[list[float]], n: int, mode: _ConvMode = "full"
) -> _Float3D: ...
@overload
def convolution_matrix(
    a: Sequence[list[complex]], n: int, mode: _ConvMode = "full"
) -> _Complex3D: ...
@overload
def convolution_matrix(
    a: onp.ToArrayStrict2D[_ScalarT, _ScalarT], n: int, mode: _ConvMode = "full"
) -> onp.Array3D[_ScalarT]: ...
@overload
def convolution_matrix(
    a: onp.ToJustBoolND, n: int, mode: _ConvMode = "full"
) -> _BoolND: ...
@overload
def convolution_matrix(
    a: onp.ToJustInt64_ND, n: int, mode: _ConvMode = "full"
) -> _IntND: ...
@overload
def convolution_matrix(
    a: onp.ToJustFloat64_ND, n: int, mode: _ConvMode = "full"
) -> _FloatND: ...
@overload
def convolution_matrix(
    a: onp.ToJustComplex128_ND, n: int, mode: _ConvMode = "full"
) -> _ComplexND: ...
@overload
def convolution_matrix(
    a: onp.ToArrayND[_ScalarT, _ScalarT], n: int, mode: _ConvMode = "full"
) -> onp.ArrayND[_ScalarT]: ...
...
@overload
def leslie(
    f: onp.ToArray1D[_ScalarT, _ScalarT], s: onp.ToArray1D[_ScalarT, _ScalarT]
) -> onp.Array2D[_ScalarT]: ...

#
@overload
def block_diag(
    arr0: onp.ToJustFloat64_1D = ..., /, *arrs: onp.ToFloat64_1D
) -> _Float2D: ...
@overload
...
@overload
def block_diag(
    arr0: onp.ToJustComplex128_1D, /, *arrs: onp.ToComplex128_1D
) -> _Complex2D: ...
@overload
def block_diag(
    arr0: onp.ToArray1D[_ScalarT, _ScalarT], /, *arrs: onp.ToArray1D[_ScalarT, _ScalarT]
) -> onp.Array2D[_ScalarT]: ...
...
@overload
def hankel(
    c: onp.ToJustIntStrict1D, r: onp.ToJustIntStrict1D | None = None
) -> _Int2D: ...
@overload
def hankel(
    c: onp.ToJustFloatStrict1D, r: onp.ToJustFloatStrict1D | None = None
) -> _Float2D: ...
@overload
def hankel(
    c: onp.ToJustComplexStrict1D, r: onp.ToJustComplexStrict1D | None = None
) -> _Complex2D: ...
@overload
def hankel(
    c: _ToStrict1D[_ScalarT], r: _ToStrict1D[_ScalarT] | None = None
) -> onp.Array2D[_ScalarT]: ...
@overload
@deprecated(
    "Beginning in SciPy 1.19, multidimensional input will be treated as a batch, not `ravel`ed."
)
...
def hankel(
    c: onp.ToJustComplexND, r: onp.ToJustComplexND | None = None
) -> _Complex2D: ...
@overload
@deprecated(
    "Beginning in SciPy 1.19, multidimensional input will be treated as a batch, not `ravel`ed."
...
def hankel(
    c: _ToStrict2ND[_ScalarT], r: _ToStrict2ND[_ScalarT] | None = None
) -> onp.Array2D[_ScalarT]: ...
@overload
def hankel(
    c: _To1D[_ScalarT], r: _To1D[_ScalarT] | None = None
) -> onp.Array2D[_ScalarT]: ...
...
) -> onp.Array2D[np.int64 | np.object_]: ...
@overload
...
@overload
def invpascal(
    n: onp.ToInt, kind: _Kind = "symmetric", *, exact: L[False]
) -> _Float2D: ...
