...
# (d1, d2, x1, y1) -> param
srotmg: Final[
    Callable[[Incomplete, Incomplete, Incomplete, Incomplete], onp.ArrayND[np.float32]]
] = ...
drotmg: Final[
    Callable[[Incomplete, Incomplete, Incomplete, Incomplete], onp.ArrayND[np.float64]]
] = ...
...
csrot: Final[
    Callable[..., tuple[onp.ArrayND[np.complex64], onp.ArrayND[np.complex64]]]
] = ...
zdrot: Final[
    Callable[..., tuple[onp.ArrayND[np.complex128], onp.ArrayND[np.complex128]]]
] = ...
